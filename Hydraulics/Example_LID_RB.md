...
> [!TIP]
> Ran clean -- no errors or warnings reported.<br>Continuity error(s): -0.424, 0.000 %

**Title:** Scenario Run :  BASE SWMM Example with LIDs  
**Location:** `Hydraulics/Example_LID_RB.inp`
...
| Simulation end | 01/01/2007 12:00:00 |
| Duration | 12 hr |
...
---
<sub>📄 Auto-generated 2026-06-24 • summary of `Example_LID_RB.inp`</sub>
