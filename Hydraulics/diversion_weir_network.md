...
> [!WARNING]
> Ran with **8 warning(s)** and no fatal errors.<br>Continuity error(s): -0.011 %

**Title:** _(no title in [TITLE] section)_  
**Location:** `Hydraulics/diversion_weir_network.inp`
...
| Simulation end | 01/01/2002 06:00 |
| Duration | 6 hr |
...
---
<sub>📄 Auto-generated 2026-06-24 • summary of `diversion_weir_network.inp`</sub>
