...
> [!CAUTION]
> **Run failed** -- 1 fatal error(s) in `extran1_power.rpt`.<br>ERROR 351: cannot open routing interface file D:\SWMMandSoftware\SWMM5.013_June2018\EPASWMM5.1.013\Swmm5.1.013UpdateTests\OWA_EXTRAN\Extran1.txt.

**Title:** Example 1 of Extran Manual  
**Location:** `Hydraulics/extran1_power.inp`
...
---
<sub>📄 Auto-generated 2026-06-24 • summary of `extran1_power.inp`</sub>
