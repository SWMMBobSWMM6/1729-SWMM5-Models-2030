...
> [!TIP]
> Ran clean -- no errors or warnings reported.<br>Continuity error(s): -1.195 %

**Title:** _(no title in [TITLE] section)_  
**Location:** `Hydraulics/linear_vsp_pump.inp`
...
---
<sub>📄 Auto-generated 2026-06-24 • summary of `linear_vsp_pump.inp`</sub>
