...
> [!TIP]
> Ran clean -- no errors or warnings reported.<br>Continuity error(s): 4.240 %

**Title:** _(no title in [TITLE] section)_  
**Location:** `Hydraulics/AkanYen.inp`
...
---
<sub>📄 Auto-generated 2026-06-24 • summary of `AkanYen.inp`</sub>
