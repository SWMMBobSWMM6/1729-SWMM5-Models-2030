# 💧 Exercise2_w_wo_SWALE_2Subcatchments.inp
...
> [!NOTE]
> No `Exercise2_w_wo_SWALE_2Subcatchments.rpt` found next to this model -- it may not have been run yet.

**Title:** Example 5 A simple groundwater example.  
**Location:** `Training/Exercise2_w_wo_SWALE_2Subcatchments.inp`
...
---
<sub>📄 Auto-generated 2026-06-24 • summary of `Exercise2_w_wo_SWALE_2Subcatchments.inp`</sub>
