# 💧 Exercise1_Horton_Huff_Distribution.inp
...
> [!NOTE]
> No `Exercise1_Horton_Huff_Distribution.rpt` found next to this model -- it may not have been run yet.

**Title:** Scenario Run :  BASE  
**Location:** `Training/Exercise1_Horton_Huff_Distribution.inp`
...
---
<sub>📄 Auto-generated 2026-06-24 • summary of `Exercise1_Horton_Huff_Distribution.inp`</sub>
