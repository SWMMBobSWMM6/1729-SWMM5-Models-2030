...
> [!NOTE]
> No `Exercise4_custom_shapes.rpt` found next to this model -- it may not have been run yet.

**Title:** Example 2 of Extran Manual - Tide Gate  
**Location:** `Training/Exercise4_custom_shapes.inp`
...
---
<sub>📄 Auto-generated 2026-06-24 • summary of `Exercise4_custom_shapes.inp`</sub>
