# 💧 Exercise1_extran1_KW_Divider.inp
...
> [!NOTE]
> No `Exercise1_extran1_KW_Divider.rpt` found next to this model -- it may not have been run yet.

**Title:** Example 1 of Extran Manual  
**Location:** `Training/Exercise1_extran1_KW_Divider.inp`
...
---
<sub>📄 Auto-generated 2026-06-24 • summary of `Exercise1_extran1_KW_Divider.inp`</sub>
