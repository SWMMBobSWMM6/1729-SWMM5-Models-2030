...
> [!NOTE]
> No `Exercise9_FORCE2.rpt` found next to this model -- it may not have been run yet.

**Title:** _(no title in [TITLE] section)_  
**Location:** `Training/Exercise9_FORCE2.inp`
...
---
<sub>📄 Auto-generated 2026-06-24 • summary of `Exercise9_FORCE2.inp`</sub>
