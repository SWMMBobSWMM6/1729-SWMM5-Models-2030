...
> [!NOTE]
> No `Exercise4_usgs_miami.rpt` found next to this model -- it may not have been run yet.

**Title:** SW 1 0 9A1 'BROWARD COUNTY Multi FAMILY SITE - Runoff example # 47'A2 'RUNO  
**Location:** `Training/Exercise4_usgs_miami.inp`
...
---
<sub>📄 Auto-generated 2026-06-24 • summary of `Exercise4_usgs_miami.inp`</sub>
