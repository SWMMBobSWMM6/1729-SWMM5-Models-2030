...
> [!NOTE]
> No `Exercise1_Cycling_pumps.rpt` found next to this model -- it may not have been run yet.

**Title:** _(no title in [TITLE] section)_  
**Location:** `Training/Exercise1_Cycling_pumps.inp`
...
---
<sub>📄 Auto-generated 2026-06-24 • summary of `Exercise1_Cycling_pumps.inp`</sub>
