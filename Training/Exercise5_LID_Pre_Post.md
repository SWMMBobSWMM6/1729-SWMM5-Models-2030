...
> [!NOTE]
> No `Exercise5_LID_Pre_Post.rpt` found next to this model -- it may not have been run yet.

**Title:** _(no title in [TITLE] section)_  
**Location:** `Training/Exercise5_LID_Pre_Post.inp`
...
---
<sub>📄 Auto-generated 2026-06-24 • summary of `Exercise5_LID_Pre_Post.inp`</sub>
