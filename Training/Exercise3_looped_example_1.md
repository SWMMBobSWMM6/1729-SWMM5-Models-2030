# 💧 Exercise3_looped_example_1.inp
...
> [!NOTE]
> No `Exercise3_looped_example_1.rpt` found next to this model -- it may not have been run yet.

**Title:** Extran with surcharge in 2 foot circular conduits SWMM CRADA Example 1  
**Location:** `Training/Exercise3_looped_example_1.inp`
...
---
<sub>📄 Auto-generated 2026-06-24 • summary of `Exercise3_looped_example_1.inp`</sub>
