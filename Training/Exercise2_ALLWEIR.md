...
> [!NOTE]
> No `Exercise2_ALLWEIR.rpt` found next to this model -- it may not have been run yet.

**Title:** _(no title in [TITLE] section)_  
**Location:** `Training/Exercise2_ALLWEIR.inp`
...
---
<sub>📄 Auto-generated 2026-06-24 • summary of `Exercise2_ALLWEIR.inp`</sub>
