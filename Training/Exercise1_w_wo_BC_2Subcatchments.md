# 💧 Exercise1_w_wo_BC_2Subcatchments.inp
...
> [!NOTE]
> No `Exercise1_w_wo_BC_2Subcatchments.rpt` found next to this model -- it may not have been run yet.

**Title:** Example 5 A simple groundwater example.  
**Location:** `Training/Exercise1_w_wo_BC_2Subcatchments.inp`
...
---
<sub>📄 Auto-generated 2026-06-24 • summary of `Exercise1_w_wo_BC_2Subcatchments.inp`</sub>
