# 💧 Exercise6_ALL_Outfall_Types.inp
...
> [!NOTE]
> No `Exercise6_ALL_Outfall_Types.rpt` found next to this model -- it may not have been run yet.

**Title:** Imported Network from SWMM4 to Test all Outfall Types in SWMM5  
**Location:** `Training/Exercise6_ALL_Outfall_Types.inp`
...
| Simulation end | 01/06/1988 06:00:00 |
...
---
<sub>📄 Auto-generated 2026-06-24 • summary of `Exercise6_ALL_Outfall_Types.inp`</sub>
