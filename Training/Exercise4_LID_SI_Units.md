...
> [!NOTE]
> No `Exercise4_LID_SI_Units.rpt` found next to this model -- it may not have been run yet.

**Title:** Ö²ÎïÔ°  
**Location:** `Training/Exercise4_LID_SI_Units.inp`
...
| Simulation start | 08/26/2013 00:00:00 |
| Simulation end | 08/26/2013 05:00:00 |
| Duration | 5 hr |
...
LID control definitions: **3** &nbsp;|&nbsp; Subcatchment deployments: **7**
...
---
<sub>📄 Auto-generated 2026-06-24 • summary of `Exercise4_LID_SI_Units.inp`</sub>
