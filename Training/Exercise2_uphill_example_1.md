# 💧 Exercise2_uphill_example_1.inp
...
> [!NOTE]
> No `Exercise2_uphill_example_1.rpt` found next to this model -- it may not have been run yet.

**Title:** Extran with flat 2 foot circular conduits  ;  SWMM CRADA Example ;  
**Location:** `Training/Exercise2_uphill_example_1.inp`
...
---
<sub>📄 Auto-generated 2026-06-24 • summary of `Exercise2_uphill_example_1.inp`</sub>
