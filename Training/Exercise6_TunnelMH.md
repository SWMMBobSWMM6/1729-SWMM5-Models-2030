...
> [!NOTE]
> No `Exercise6_TunnelMH.rpt` found next to this model -- it may not have been run yet.

**Title:** Test  
**Location:** `Training/Exercise6_TunnelMH.inp`
...
---
<sub>📄 Auto-generated 2026-06-24 • summary of `Exercise6_TunnelMH.inp`</sub>
