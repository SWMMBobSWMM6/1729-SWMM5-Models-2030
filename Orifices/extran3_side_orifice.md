...
> [!CAUTION]
> **Run failed** -- 1 fatal error(s) in `extran3_side_orifice.rpt`.<br>ERROR 351: cannot open routing interface file D:\SWMMandSoftware\SWMM5.013_June2018\EPASWMM5.1.013\Swmm5.1.013UpdateTests\OWA_EXTRAN\Extran3.txt.

**Title:** Example 3 of Extran Manual - Sump Orifice  
**Location:** `Orifices/extran3_side_orifice.inp`
...
---
<sub>📄 Auto-generated 2026-06-24 • summary of `extran3_side_orifice.inp`</sub>
