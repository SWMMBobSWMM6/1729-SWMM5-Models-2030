# 💧 lid_multi_lids_one_subcatch.inp
...
> [!WARNING]
> Ran with **1 warning(s)** and no fatal errors.<br>Continuity error(s): -3.203, 0.000 %

**Title:** Test multiple LID types on single subcatchment A simple groundwater example.  
**Location:** `LID/lid_multi_lids_one_subcatch.inp`
...
---
<sub>📄 Auto-generated 2026-06-24 • summary of `lid_multi_lids_one_subcatch.inp`</sub>
