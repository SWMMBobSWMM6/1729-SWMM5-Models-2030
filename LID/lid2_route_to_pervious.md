...
> [!WARNING]
> Ran with **1 warning(s)** and no fatal errors.<br>Continuity error(s): -0.253, 0.000 %

**Title:** LID RouteTo=PERVIOUS PctRouted=75 A simple groundwater example.  
**Location:** `LID/lid2_route_to_pervious.inp`
...
---
<sub>📄 Auto-generated 2026-06-24 • summary of `lid2_route_to_pervious.inp`</sub>
