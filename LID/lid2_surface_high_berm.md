...
> [!WARNING]
> Ran with **1 warning(s)** and no fatal errors.<br>Continuity error(s): -0.177, 0.000 %

**Title:** LID Surface: High berm=24 A simple groundwater example.  
**Location:** `LID/lid2_surface_high_berm.inp`
...
---
<sub>📄 Auto-generated 2026-06-24 • summary of `lid2_surface_high_berm.inp`</sub>
