...
> [!WARNING]
> Ran with **1 warning(s)** and no fatal errors.<br>Continuity error(s): -0.176, 0.000 %

**Title:** LID PP: ImpervFrac=0.75 A simple groundwater example.  
**Location:** `LID/lid2_pp_imperv_frac.inp`
...
---
<sub>📄 Auto-generated 2026-06-24 • summary of `lid2_pp_imperv_frac.inp`</sub>
