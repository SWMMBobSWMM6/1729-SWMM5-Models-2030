...
> [!WARNING]
> Ran with **1 warning(s)** and no fatal errors.<br>Continuity error(s): -0.207, 0.000 %

**Title:** IT Cistern: large storage=120in, no soil A simple groundwater example.  
**Location:** `LID/lid2_it_cistern_large.inp`
...
---
<sub>📄 Auto-generated 2026-06-24 • summary of `lid2_it_cistern_large.inp`</sub>
