...
> [!WARNING]
> Ran with **1 warning(s)** and no fatal errors.<br>Continuity error(s): -0.493, 0.000 %

**Title:** LID with ADJUSTMENTS for monthly evaporation and rainfall A simple groundwater example.  
**Location:** `LID/lid2_adjustments.inp`
...
---
<sub>📄 Auto-generated 2026-06-24 • summary of `lid2_adjustments.inp`</sub>
