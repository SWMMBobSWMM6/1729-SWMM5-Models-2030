...
> [!WARNING]
> Ran with **1 warning(s)** and no fatal errors.<br>Continuity error(s): -0.208, 0.000 %

**Title:** Test LID with FromPerv = 50 (barely tested) A simple groundwater example.  
**Location:** `LID/lid_bc_from_pervious.inp`
...
---
<sub>📄 Auto-generated 2026-06-24 • summary of `lid_bc_from_pervious.inp`</sub>
