...
> [!WARNING]
> Ran with **1 warning(s)** and no fatal errors.<br>Continuity error(s): -0.168, 0.000 %

**Title:** GR Green Roof: drainmat rough=0.5 A simple groundwater example.  
**Location:** `LID/lid2_gr_rough_drainmat.inp`
...
---
<sub>📄 Auto-generated 2026-06-24 • summary of `lid2_gr_rough_drainmat.inp`</sub>
