...
> [!WARNING]
> Ran with **1 warning(s)** and no fatal errors.<br>Continuity error(s): -0.187, 0.000, 0.000 %

**Title:** Test BC LID with GROUNDWATER/AQUIFER interaction A simple groundwater example.  
**Location:** `LID/lid_bc_with_groundwater.inp`
...
---
<sub>📄 Auto-generated 2026-06-24 • summary of `lid_bc_with_groundwater.inp`</sub>
