...
> [!WARNING]
> Ran with **1 warning(s)** and no fatal errors.<br>Continuity error(s): -0.200, 0.000 %

**Title:** LID Usage: Same LID on both subcatchments A simple groundwater example.  
**Location:** `LID/lid2_usage_both_subcatch.inp`
...
LID control definitions: **1** &nbsp;|&nbsp; Subcatchment deployments: **2**
...
---
<sub>📄 Auto-generated 2026-06-24 • summary of `lid2_usage_both_subcatch.inp`</sub>
