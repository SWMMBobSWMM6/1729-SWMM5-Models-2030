...
> [!CAUTION]
> **Run failed** -- 2 fatal error(s) in `lid_bc_removals_multi_wq.rpt`.<br>ERROR 205: invalid keyword 250 at line 116 of [BUILDUP] section:; ERROR 205: invalid keyword 100 at line 118 of [BUILDUP] section:

**Title:** Test BC with REMOVALS layer for multiple pollutants A simple groundwater example.  
**Location:** `LID/lid_bc_removals_multi_wq.inp`
...
---
<sub>📄 Auto-generated 2026-06-24 • summary of `lid_bc_removals_multi_wq.inp`</sub>
