...
> [!WARNING]
> Ran with **1 warning(s)** and no fatal errors.<br>Continuity error(s): -0.038, 0.000 %

**Title:** Test Infiltration Trench (IT) with optional soil layer A simple groundwater example.  
**Location:** `LID/lid_it_with_soil_layer.inp`
...
---
<sub>📄 Auto-generated 2026-06-24 • summary of `lid_it_with_soil_layer.inp`</sub>
