...
> [!CAUTION]
> **Run failed** -- 1 fatal error(s) in `lid_pp_clog_regen.rpt`.<br>ERROR 211: invalid number 28 at line 78 of [LID_CONTROL] section:

**Title:** Test PP with pavement clogging and regeneration interval A simple groundwater example.  
**Location:** `LID/lid_pp_clog_regen.inp`
...
---
<sub>📄 Auto-generated 2026-06-24 • summary of `lid_pp_clog_regen.inp`</sub>
