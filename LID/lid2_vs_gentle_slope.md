...
> [!WARNING]
> Ran with **1 warning(s)** and no fatal errors.<br>Continuity error(s): -271.439, 0.000 %

**Title:** VS Swale: side slopes = 3:1 (gentle) A simple groundwater example.  
**Location:** `LID/lid2_vs_gentle_slope.inp`
...
---
<sub>📄 Auto-generated 2026-06-24 • summary of `lid2_vs_gentle_slope.inp`</sub>
