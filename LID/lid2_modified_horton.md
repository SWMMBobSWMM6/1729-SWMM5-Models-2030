...
> [!WARNING]
> Ran with **1 warning(s)** and no fatal errors.<br>Continuity error(s): -0.183, 0.000 %

**Title:** LID with MODIFIED_HORTON infiltration A simple groundwater example.  
**Location:** `LID/lid2_modified_horton.inp`
...
---
<sub>📄 Auto-generated 2026-06-24 • summary of `lid2_modified_horton.inp`</sub>
