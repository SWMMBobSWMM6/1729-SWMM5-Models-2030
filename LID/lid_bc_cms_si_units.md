...
> [!CAUTION]
> **Run failed** -- 1 fatal error(s) in `lid_bc_cms_si_units.rpt`.<br>ERROR 211: invalid number 6.35 at line 77 of [LID_CONTROL] section:

**Title:** Test FLOW_UNITS CMS CMS with LID (all files use CFS) A simple groundwater example.  
**Location:** `LID/lid_bc_cms_si_units.inp`
...
---
<sub>📄 Auto-generated 2026-06-24 • summary of `lid_bc_cms_si_units.inp`</sub>
