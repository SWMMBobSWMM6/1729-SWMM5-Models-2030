# 💧 lid2_usage_fully_saturated.inp
...
> [!WARNING]
> Ran with **1 warning(s)** and no fatal errors.<br>Continuity error(s): -0.178, 0.000 %

**Title:** LID Usage: InitSat=100 (fully saturated) A simple groundwater example.  
**Location:** `LID/lid2_usage_fully_saturated.inp`
...
---
<sub>📄 Auto-generated 2026-06-24 • summary of `lid2_usage_fully_saturated.inp`</sub>
