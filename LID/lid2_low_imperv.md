...
> [!WARNING]
> Ran with **1 warning(s)** and no fatal errors.<br>Continuity error(s): -0.089, 0.000 %

**Title:** LID on low-imperv (5%) subcatchment A simple groundwater example.  
**Location:** `LID/lid2_low_imperv.inp`
...
---
<sub>📄 Auto-generated 2026-06-24 • summary of `lid2_low_imperv.inp`</sub>
