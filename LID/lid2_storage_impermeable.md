...
> [!WARNING]
> Ran with **1 warning(s)** and no fatal errors.<br>Continuity error(s): -0.182, 0.000 %

**Title:** LID Storage: Ksat=0 (impermeable liner) A simple groundwater example.  
**Location:** `LID/lid2_storage_impermeable.inp`
...
---
<sub>📄 Auto-generated 2026-06-24 • summary of `lid2_storage_impermeable.inp`</sub>
