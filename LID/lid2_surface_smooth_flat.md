...
> [!WARNING]
> Ran with **1 warning(s)** and no fatal errors.<br>Continuity error(s): -0.186, 0.000 %

**Title:** LID Surface: Roughness=0, Slope=0 (smooth/flat) A simple groundwater example.  
**Location:** `LID/lid2_surface_smooth_flat.inp`
...
---
<sub>📄 Auto-generated 2026-06-24 • summary of `lid2_surface_smooth_flat.inp`</sub>
