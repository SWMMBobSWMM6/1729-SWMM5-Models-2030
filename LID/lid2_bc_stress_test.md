...
> [!CAUTION]
> **Run failed** -- 1 fatal error(s) in `lid2_bc_stress_test.rpt`.<br>ERROR 205: invalid keyword 250 at line 101 of [BUILDUP] section:

**Title:** BC stress test: deep berm, thick soil, deep storage A simple groundwater example.  
**Location:** `LID/lid2_bc_stress_test.inp`
...
---
<sub>📄 Auto-generated 2026-06-24 • summary of `lid2_bc_stress_test.inp`</sub>
