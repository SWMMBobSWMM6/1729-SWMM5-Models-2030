...
> [!WARNING]
> Ran with **1 warning(s)** and no fatal errors.<br>Continuity error(s): -0.195, 0.000 %

**Title:** Test LID Type: Rooftop Disconnection (RD) - never tested A simple groundwater example.  
**Location:** `LID/lid_rooftop_disconnection.inp`
...
---
<sub>📄 Auto-generated 2026-06-24 • summary of `lid_rooftop_disconnection.inp`</sub>
