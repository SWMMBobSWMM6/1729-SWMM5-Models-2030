...
> [!WARNING]
> Ran with **1 warning(s)** and no fatal errors.<br>Continuity error(s): -0.196, 0.000 %

**Title:** RB Rain Barrel: large storage=72in A simple groundwater example.  
**Location:** `LID/lid2_rb_large_barrel.inp`
...
---
<sub>📄 Auto-generated 2026-06-24 • summary of `lid2_rb_large_barrel.inp`</sub>
