...
> [!WARNING]
> Ran with **1 warning(s)** and no fatal errors.<br>Continuity error(s): -946.807, 0.000 %

**Title:** VS Swale: side slopes = 8:1 (steep) A simple groundwater example.  
**Location:** `LID/lid2_vs_steep_slope.inp`
...
---
<sub>📄 Auto-generated 2026-06-24 • summary of `lid2_vs_steep_slope.inp`</sub>
