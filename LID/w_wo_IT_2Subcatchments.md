...
> [!CAUTION]
> **Run failed** -- 1 fatal error(s) in `w_wo_IT_2Subcatchments.rpt`.<br>ERROR 305: cannot open report file.at line 84 of [LID_USAGE] section:

**Title:** Example 5 A simple groundwater example.  
**Location:** `LID/w_wo_IT_2Subcatchments.inp`
...
---
<sub>📄 Auto-generated 2026-06-24 • summary of `w_wo_IT_2Subcatchments.inp`</sub>
