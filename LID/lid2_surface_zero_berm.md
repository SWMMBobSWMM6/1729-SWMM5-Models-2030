...
> [!WARNING]
> Ran with **1 warning(s)** and no fatal errors.<br>Continuity error(s): -0.185, 0.000 %

**Title:** LID Surface: Zero berm (no ponding) A simple groundwater example.  
**Location:** `LID/lid2_surface_zero_berm.inp`
...
---
<sub>📄 Auto-generated 2026-06-24 • summary of `lid2_surface_zero_berm.inp`</sub>
