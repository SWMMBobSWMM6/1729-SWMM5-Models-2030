...
> [!WARNING]
> Ran with **1 warning(s)** and no fatal errors.<br>Continuity error(s): -0.192, 0.000 %

**Title:** Test LID Type: Rain Barrel (RB) with high InitSat and drain control A simple groundwater example.  
**Location:** `LID/lid_rain_barrel_initsol.inp`
...
---
<sub>📄 Auto-generated 2026-06-24 • summary of `lid_rain_barrel_initsol.inp`</sub>
