...
> [!WARNING]
> Ran with **1 warning(s)** and no fatal errors.<br>Continuity error(s): -0.233, 0.000 %

**Title:** Test BC LID on high imperviousness (90%) subcatchment A simple groundwater example.  
**Location:** `LID/lid_bc_high_imperv.inp`
...
---
<sub>📄 Auto-generated 2026-06-24 • summary of `lid_bc_high_imperv.inp`</sub>
