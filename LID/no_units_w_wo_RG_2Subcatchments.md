# 💧 no_units_w_wo_RG_2Subcatchments.inp
...
> [!TIP]
> Ran clean -- no errors or warnings reported.<br>Continuity error(s): -0.020, 0.000 %

**Title:** Example 5 A simple groundwater example.  
**Location:** `LID/no_units_w_wo_RG_2Subcatchments.inp`
...
---
<sub>📄 Auto-generated 2026-06-24 • summary of `no_units_w_wo_RG_2Subcatchments.inp`</sub>
