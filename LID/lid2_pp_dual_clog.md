...
> [!CAUTION]
> **Run failed** -- 1 fatal error(s) in `lid2_pp_dual_clog.rpt`.<br>ERROR 211: invalid number 28 at line 78 of [LID_CONTROL] section:

**Title:** LID PP: Both pavement AND storage clogging A simple groundwater example.  
**Location:** `LID/lid2_pp_dual_clog.inp`
...
---
<sub>📄 Auto-generated 2026-06-24 • summary of `lid2_pp_dual_clog.inp`</sub>
