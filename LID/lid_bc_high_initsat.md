...
> [!WARNING]
> Ran with **1 warning(s)** and no fatal errors.<br>Continuity error(s): -0.179, 0.000 %

**Title:** Test LID with InitSat = 75% (high initial saturation) A simple groundwater example.  
**Location:** `LID/lid_bc_high_initsat.inp`
...
---
<sub>📄 Auto-generated 2026-06-24 • summary of `lid_bc_high_initsat.inp`</sub>
