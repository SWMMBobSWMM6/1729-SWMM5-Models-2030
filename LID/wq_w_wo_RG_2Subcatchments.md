...
> [!TIP]
> Ran clean -- no errors or warnings reported.<br>Continuity error(s): -0.023, -0.967, 0.000 %

**Title:** Example 5 A simple groundwater example.  
**Location:** `LID/wq_w_wo_RG_2Subcatchments.inp`
...
---
<sub>📄 Auto-generated 2026-06-24 • summary of `wq_w_wo_RG_2Subcatchments.inp`</sub>
