# 💧 w_wo_BC_2Subcatchments_Mod_GA.inp
...
> [!WARNING]
> Ran with **1 warning(s)** and no fatal errors.<br>Continuity error(s): -0.121, 0.000 %

**Title:** Lid Example with Bio Cell  
**Location:** `LID/w_wo_BC_2Subcatchments_Mod_GA.inp`
...
---
<sub>📄 Auto-generated 2026-06-24 • summary of `w_wo_BC_2Subcatchments_Mod_GA.inp`</sub>
