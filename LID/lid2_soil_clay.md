...
> [!WARNING]
> Ran with **1 warning(s)** and no fatal errors.<br>Continuity error(s): -0.172, 0.000 %

**Title:** LID Soil: Clay (low Ksat=0.01, high WP) A simple groundwater example.  
**Location:** `LID/lid2_soil_clay.inp`
...
---
<sub>📄 Auto-generated 2026-06-24 • summary of `lid2_soil_clay.inp`</sub>
