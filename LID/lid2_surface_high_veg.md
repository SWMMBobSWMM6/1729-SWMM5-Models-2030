...
> [!WARNING]
> Ran with **1 warning(s)** and no fatal errors.<br>Continuity error(s): -1.515, 0.000 %

**Title:** LID Surface: VegFrac=0.9 (dense vegetation) A simple groundwater example.  
**Location:** `LID/lid2_surface_high_veg.inp`
...
---
<sub>📄 Auto-generated 2026-06-24 • summary of `lid2_surface_high_veg.inp`</sub>
