...
> [!WARNING]
> Ran with **1 warning(s)** and no fatal errors.<br>Continuity error(s): -241.527, 0.000 %

**Title:** Test Vegetative Swale (VS) with varied geometry params A simple groundwater example.  
**Location:** `LID/lid_swale_varied_geometry.inp`
...
---
<sub>📄 Auto-generated 2026-06-24 • summary of `lid_swale_varied_geometry.inp`</sub>
