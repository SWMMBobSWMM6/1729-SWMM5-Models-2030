...
> [!WARNING]
> Ran with **1 warning(s)** and no fatal errors.<br>Continuity error(s): -0.169, 0.000 %

**Title:** Test PP Permeable Pavement without underdrain (no DRAIN) A simple groundwater example.  
**Location:** `LID/lid_pp_no_underdrain.inp`
...
---
<sub>📄 Auto-generated 2026-06-24 • summary of `lid_pp_no_underdrain.inp`</sub>
