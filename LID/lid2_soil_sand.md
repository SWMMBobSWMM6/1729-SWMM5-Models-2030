...
> [!WARNING]
> Ran with **1 warning(s)** and no fatal errors.<br>Continuity error(s): -0.180, 0.000 %

**Title:** LID Soil: Sandy (high Ksat=4.74, low FC) A simple groundwater example.  
**Location:** `LID/lid2_soil_sand.inp`
...
---
<sub>📄 Auto-generated 2026-06-24 • summary of `lid2_soil_sand.inp`</sub>
