...
> [!WARNING]
> Ran with **1 warning(s)** and no fatal errors.<br>Continuity error(s): -0.216, 0.000 %

**Title:** Test EVAPORATION = MONTHLY with LID (under-tested) A simple groundwater example.  
**Location:** `LID/lid_bc_evap_monthly.inp`
...
---
<sub>📄 Auto-generated 2026-06-24 • summary of `lid_bc_evap_monthly.inp`</sub>
