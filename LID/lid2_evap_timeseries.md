...
> [!WARNING]
> Ran with **1 warning(s)** and no fatal errors.<br>Continuity error(s): -0.215, 0.000 %

**Title:** LID with EVAPORATION = TIMESERIES A simple groundwater example.  
**Location:** `LID/lid2_evap_timeseries.inp`
...
---
<sub>📄 Auto-generated 2026-06-24 • summary of `lid2_evap_timeseries.inp`</sub>
