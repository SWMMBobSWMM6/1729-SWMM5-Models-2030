# 💧 w_wo_LID_Trench_2Subcatchments.inp
...
> [!WARNING]
> Ran with **1 warning(s)** and no fatal errors.<br>Continuity error(s): -0.007, -0.025 %

**Title:** Example 5 A simple groundwater example.  
**Location:** `LID/w_wo_LID_Trench_2Subcatchments.inp`
...
---
<sub>📄 Auto-generated 2026-06-24 • summary of `w_wo_LID_Trench_2Subcatchments.inp`</sub>
