...
> [!WARNING]
> Ran with **1 warning(s)** and no fatal errors.<br>Continuity error(s): -0.167, 0.000 %

**Title:** Test Green Roof (GR) with varied drainmat parameters A simple groundwater example.  
**Location:** `LID/lid_green_roof_drainmat.inp`
...
---
<sub>📄 Auto-generated 2026-06-24 • summary of `lid_green_roof_drainmat.inp`</sub>
