...
> [!CAUTION]
> **Run failed** -- 1 fatal error(s) in `lid_bc_evap_temperature.rpt`.<br>ERROR 337: cannot open climate file C:\Users\rober\OneDrive\Documents\GitHub\1729-SWMM5-Models\LID\climate.dat.

**Title:** Test EVAPORATION = TEMPERATURE with LID (not tested) A simple groundwater example.  
**Location:** `LID/lid_bc_evap_temperature.inp`
...
---
<sub>📄 Auto-generated 2026-06-24 • summary of `lid_bc_evap_temperature.inp`</sub>
