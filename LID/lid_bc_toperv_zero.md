...
> [!WARNING]
> Ran with **1 warning(s)** and no fatal errors.<br>Continuity error(s): -0.184, 0.000 %

**Title:** Test LID with ToPerv=0 (overflow goes to subcatchment outlet) A simple groundwater example.  
**Location:** `LID/lid_bc_toperv_zero.inp`
...
---
<sub>📄 Auto-generated 2026-06-24 • summary of `lid_bc_toperv_zero.inp`</sub>
