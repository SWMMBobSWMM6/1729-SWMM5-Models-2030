...
> [!TIP]
> Ran clean -- no errors or warnings reported.<br>Continuity error(s): -0.034, 0.000 %

**Title:** Example 5 A simple groundwater example.  
**Location:** `LID/w_wo_RB_2Subcatchments.inp`
...
---
<sub>📄 Auto-generated 2026-06-24 • summary of `w_wo_RB_2Subcatchments.inp`</sub>
