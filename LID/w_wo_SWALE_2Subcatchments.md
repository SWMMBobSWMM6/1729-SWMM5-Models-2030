...
> [!TIP]
> Ran clean -- no errors or warnings reported.<br>Continuity error(s): -19.749, 0.000 %

**Title:** Example 5 A simple groundwater example.  
**Location:** `LID/w_wo_SWALE_2Subcatchments.inp`
...
---
<sub>📄 Auto-generated 2026-06-24 • summary of `w_wo_SWALE_2Subcatchments.inp`</sub>
