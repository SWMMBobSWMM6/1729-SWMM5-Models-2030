# 💧 lid_bc_full_imperv_capture.inp
...
> [!WARNING]
> Ran with **1 warning(s)** and no fatal errors.<br>Continuity error(s): -0.225, 0.000 %

**Title:** Test BC with FromImp=100 (all impervious runoff to LID) A simple groundwater example.  
**Location:** `LID/lid_bc_full_imperv_capture.inp`
...
---
<sub>📄 Auto-generated 2026-06-24 • summary of `lid_bc_full_imperv_capture.inp`</sub>
