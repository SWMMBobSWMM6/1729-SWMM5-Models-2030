...
> [!WARNING]
> Ran with **1 warning(s)** and no fatal errors.<br>Continuity error(s): -0.151, 0.000 %

**Title:** Test INFILTRATION CURVE_NUMBER CURVE_NUMBER with LID (not tested) A simple groundwater example.  
**Location:** `LID/lid_bc_curve_number.inp`
...
---
<sub>📄 Auto-generated 2026-06-24 • summary of `lid_bc_curve_number.inp`</sub>
