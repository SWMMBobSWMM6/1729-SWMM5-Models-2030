...
> [!WARNING]
> Ran with **1 warning(s)** and no fatal errors.<br>Continuity error(s): -0.191, 0.000 %

**Title:** Test SUBAREAS RouteTo = IMPERVIOUS (not tested) A simple groundwater example.  
**Location:** `LID/lid_bc_route_to_imperv.inp`
...
---
<sub>📄 Auto-generated 2026-06-24 • summary of `lid_bc_route_to_imperv.inp`</sub>
