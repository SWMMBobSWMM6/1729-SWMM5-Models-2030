...
> [!WARNING]
> Ran with **1 warning(s)** and no fatal errors.<br>Continuity error(s): -0.181, 0.000 %

**Title:** LID Usage: FromImp=0 FromPerv=100 (perv only) A simple groundwater example.  
**Location:** `LID/lid2_usage_perv_only.inp`
...
---
<sub>📄 Auto-generated 2026-06-24 • summary of `lid2_usage_perv_only.inp`</sub>
