...
> [!CAUTION]
> **Run failed** -- 1 fatal error(s) in `lid_combo_bc_gr_rb_rd_wq.rpt`.<br>ERROR 205: invalid keyword 250 at line 124 of [BUILDUP] section:

**Title:** Combo test: BC + GR + RB + RD on same subcatchment with WQ A simple groundwater example.  
**Location:** `LID/lid_combo_bc_gr_rb_rd_wq.inp`
...
---
<sub>📄 Auto-generated 2026-06-24 • summary of `lid_combo_bc_gr_rb_rd_wq.inp`</sub>
