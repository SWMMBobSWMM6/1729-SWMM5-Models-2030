...
> [!CAUTION]
> **Run failed** -- 1 fatal error(s) in `RUNOFF40_SW5.rpt`.<br>ERROR 323: cannot open runoff interface file D:\SWMMandSoftware\swmm_crada_files\Other SWMM5 Files\RUNOFF40.INT.

**Title:** _(no title in [TITLE] section)_  
**Location:** `Hydrology/RUNOFF40_SW5.inp`
...
| Simulation end | 05/23/1985 15:00:00 |
| Duration | 3 hr |
...
---
<sub>📄 Auto-generated 2026-06-24 • summary of `RUNOFF40_SW5.inp`</sub>
