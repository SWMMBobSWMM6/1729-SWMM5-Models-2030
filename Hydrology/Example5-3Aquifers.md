...
> [!TIP]
> Ran clean -- no errors or warnings reported.<br>Continuity error(s): -0.007, 0.000, 0.000 %

**Title:** Example 5 A simple groundwater example.  
**Location:** `Hydrology/Example5-3Aquifers.inp`
...
---
<sub>📄 Auto-generated 2026-06-24 • summary of `Example5-3Aquifers.inp`</sub>
