...
> [!CAUTION]
> **Run failed** -- 4 fatal error(s) in `rtk_usgs_runoff_rdiii.rpt`.<br>ERROR 235: invalid infiltration parameters at line 73 of [INFIL] section:; ERROR 235: invalid infiltration parameters at line 74 of [INFIL] section:

**Title:** make a change and have it stick  
**Location:** `Hydrology/rtk_usgs_runoff_rdiii.inp`
...
---
<sub>📄 Auto-generated 2026-06-24 • summary of `rtk_usgs_runoff_rdiii.inp`</sub>
