...
> [!CAUTION]
> **Run failed** -- 1 fatal error(s) in `RUNOFF43_SW5.rpt`.<br>ERROR 323: cannot open runoff interface file D:\SWMMandSoftware\swmm_crada_files\Other SWMM5 Files\RUNOFF43.INT.

**Title:** SW 1 0 9 A1 'BROWARD COUNTY Multi FAMILY SITE - Runoff example # 43'A2 'RUN  
**Location:** `Hydrology/RUNOFF43_SW5.inp`
...
| Simulation start | 05/04/1977 07:35:00 |
| Simulation end | 05/04/1977 20:40:00 |
...
---
<sub>📄 Auto-generated 2026-06-24 • summary of `RUNOFF43_SW5.inp`</sub>
