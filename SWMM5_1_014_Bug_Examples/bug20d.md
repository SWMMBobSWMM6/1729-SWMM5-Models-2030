...
> [!CAUTION]
> **Run failed** -- 2 fatal error(s) in `bug20d.rpt`.<br>ERROR 235: invalid infiltration parameters at line 77 of [INFIL] section:; ERROR 235: invalid infiltration parameters at line 78 of [INFIL] section:

**Title:** Alternate 3 - Demonstrates the fix for a v5.1.013 bug that produced incorrect rainfall when the same time series was used by one rain gage assigned to a Unit Hydrograph and another assigned to a subcatchment. The results for total RDII volu…  
**Location:** `SWMM5_1_014_Bug_Examples/bug20d.inp`
...
---
<sub>📄 Auto-generated 2026-06-24 • summary of `bug20d.inp`</sub>
