...
> [!CAUTION]
> **Run failed** -- 1 fatal error(s) in `ncdc_format.rpt`.<br>ERROR 317: cannot open rainfall data file D:\SWMMandSoftware\SWMM5.013_June2018\EPASWMM5.1.013\Swmm5.1.013UpdateTests\DataFiles\ncdc_format_old.dat.

**Title:** _(no title in [TITLE] section)_  
**Location:** `OWA_update_v5111/ncdc_format.inp`
...
| Simulation end | 06/29/2013 00:00:00 |
| Duration | 179 days |
...
---
<sub>📄 Auto-generated 2026-06-24 • summary of `ncdc_format.inp`</sub>
