...
> [!CAUTION]
> **Run failed** -- 2 fatal error(s) in `catchment_as_outfall.rpt`.<br>ERROR 235: invalid infiltration parameters at line 68 of [INFIL] section:; ERROR 235: invalid infiltration parameters at line 69 of [INFIL] section:

**Title:** _(no title in [TITLE] section)_  
**Location:** `OWA_update_v5111/catchment_as_outfall.inp`
...
| Simulation end | 01/01/2000 06:00:00 |
| Duration | 6 hr |
...
---
<sub>📄 Auto-generated 2026-06-24 • summary of `catchment_as_outfall.inp`</sub>
