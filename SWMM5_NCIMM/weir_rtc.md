...
> [!WARNING]
> Ran with **2 warning(s)** and no fatal errors.<br>Continuity error(s): -1.191 %

**Title:** _(no title in [TITLE] section)_  
**Location:** `SWMM5_NCIMM/weir_rtc.inp`
...
---
<sub>📄 Auto-generated 2026-06-24 • summary of `weir_rtc.inp`</sub>
