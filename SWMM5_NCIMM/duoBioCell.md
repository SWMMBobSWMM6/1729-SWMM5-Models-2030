...
> [!TIP]
> Ran clean -- no errors or warnings reported.<br>Continuity error(s): -0.039, 100.000, 0.000 %

**Title:** Scenario Run :  BASE LID Model  
**Location:** `SWMM5_NCIMM/duoBioCell.inp`
...
LID control definitions: **2** &nbsp;|&nbsp; Subcatchment deployments: **2**
...
---
<sub>📄 Auto-generated 2026-06-24 • summary of `duoBioCell.inp`</sub>
