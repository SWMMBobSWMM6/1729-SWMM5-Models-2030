# 💧 HIGH_BC_CRITICAL_UPSTREAM_DOWNSTREAM_EXAMPLE_SW5.inp
...
> [!TIP]
> Ran clean -- no errors or warnings reported.<br>Continuity error(s): 0.769 %

**Title:** Extran with surcharge in 2 foot circular conduits SWMM CRADA Example 1  
**Location:** `SWMM5_NCIMM/HIGH_BC_CRITICAL_UPSTREAM_DOWNSTREAM_EXAMPLE_SW5.INP`
...
---
<sub>📄 Auto-generated 2026-06-24 • summary of `HIGH_BC_CRITICAL_UPSTREAM_DOWNSTREAM_EXAMPLE_SW5.inp`</sub>
