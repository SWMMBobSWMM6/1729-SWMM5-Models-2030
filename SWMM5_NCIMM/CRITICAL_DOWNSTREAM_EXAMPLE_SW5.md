# 💧 CRITICAL_DOWNSTREAM_EXAMPLE_SW5.inp
...
> [!TIP]
> Ran clean -- no errors or warnings reported.<br>Continuity error(s): 8.428 %

**Title:** Extran with surcharge in 2 foot circular conduits SWMM CRADA Example 1  
**Location:** `SWMM5_NCIMM/CRITICAL_DOWNSTREAM_EXAMPLE_SW5.INP`
...
| Simulation end | 02/22/2002 00:25:00 |
| Duration | 25 min |
...
---
<sub>📄 Auto-generated 2026-06-24 • summary of `CRITICAL_DOWNSTREAM_EXAMPLE_SW5.inp`</sub>
