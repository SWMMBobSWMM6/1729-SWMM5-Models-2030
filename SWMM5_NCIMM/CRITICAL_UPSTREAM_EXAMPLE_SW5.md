# 💧 CRITICAL_UPSTREAM_EXAMPLE_SW5.inp
...
> [!TIP]
> Ran clean -- no errors or warnings reported.<br>Continuity error(s): 12.012 %

**Title:** Input and Output FilesSW 1 0 20  
**Location:** `SWMM5_NCIMM/CRITICAL_UPSTREAM_EXAMPLE_SW5.INP`
...
---
<sub>📄 Auto-generated 2026-06-24 • summary of `CRITICAL_UPSTREAM_EXAMPLE_SW5.inp`</sub>
