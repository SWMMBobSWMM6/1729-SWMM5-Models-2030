...
> [!TIP]
> Ran clean -- no errors or warnings reported.<br>Continuity error(s): -1.210 %

**Title:** _(no title in [TITLE] section)_  
**Location:** `SWMM5_NCIMM/vsp_master.inp`
...
---
<sub>📄 Auto-generated 2026-06-24 • summary of `vsp_master.inp`</sub>
