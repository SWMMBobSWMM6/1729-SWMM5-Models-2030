...
> [!WARNING]
> Ran with **60 warning(s)** and no fatal errors.<br>Continuity error(s): 0.985 %

**Title:** Scenario Run :  BASE  
**Location:** `SWMM5_NCIMM/pitfalls.inp`
...
---
<sub>📄 Auto-generated 2026-06-24 • summary of `pitfalls.inp`</sub>
