...
> [!TIP]
> Ran clean -- no errors or warnings reported.<br>Continuity error(s): -0.143 %

**Title:** EXTRAN EXAMPLE # 60 - SYSTEM WITH TWO LEVELS OF SURCHARGE SCHEME 1 AS IN KASSEM THESIS WITH TRAPEZOIDAL INFLOW BY A. Y.  
**Location:** `SWMM5_NCIMM/EXAM60_SW5.INP`
...
---
<sub>📄 Auto-generated 2026-06-24 • summary of `EXAM60_SW5.inp`</sub>
