...
> [!WARNING]
> Ran with **10 warning(s)** and no fatal errors.<br>Continuity error(s): 0.009 %

**Title:** Extran with surcharge in 2 foot circular conduits SWMM CRADA Example 1  
**Location:** `SWMM5_NCIMM/STEEP_drop_example_1_SW5.INP`
...
| Simulation end | 02/22/2002 05:33:00 |
...
---
<sub>📄 Auto-generated 2026-06-24 • summary of `STEEP_drop_example_1_SW5.inp`</sub>
