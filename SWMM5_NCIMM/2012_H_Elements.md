...
> [!CAUTION]
> **Run failed** -- 1 fatal error(s) in `2012_H_Elements.rpt`.<br>ERROR 191: simulation start date comes after ending date.

**Title:** _(no title in [TITLE] section)_  
**Location:** `SWMM5_NCIMM/2012_H_Elements.inp`
...
---
<sub>📄 Auto-generated 2026-06-24 • summary of `2012_H_Elements.inp`</sub>
