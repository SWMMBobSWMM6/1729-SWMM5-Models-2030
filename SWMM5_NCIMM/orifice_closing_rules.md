...
> [!WARNING]
> Ran with **1 warning(s)** and no fatal errors.<br>Continuity error(s): -0.965 %

**Title:** _(no title in [TITLE] section)_  
**Location:** `SWMM5_NCIMM/orifice_closing_rules.INP`
...
---
<sub>📄 Auto-generated 2026-06-24 • summary of `orifice_closing_rules.inp`</sub>
