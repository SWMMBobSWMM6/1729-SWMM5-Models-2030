...
> [!TIP]
> Ran clean -- no errors or warnings reported.<br>Continuity error(s): 0.540 %

**Title:** _(no title in [TITLE] section)_  
**Location:** `SWMM5_NCIMM/orifice.inp`
...
---
<sub>📄 Auto-generated 2026-06-24 • summary of `orifice.inp`</sub>
