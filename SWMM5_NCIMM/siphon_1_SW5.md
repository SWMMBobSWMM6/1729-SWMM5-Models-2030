...
> [!WARNING]
> Ran with **8 warning(s)** and no fatal errors.<br>Continuity error(s): 0.063 %

**Title:** Extran with surcharge in 2 foot circular conduits SWMM CRADA Example 1  
**Location:** `SWMM5_NCIMM/siphon_1_SW5.INP`
...
---
<sub>📄 Auto-generated 2026-06-24 • summary of `siphon_1_SW5.inp`</sub>
