...
> [!WARNING]
> Ran with **9 warning(s)** and no fatal errors.<br>Continuity error(s): -12.989 %

**Title:** Extran with surcharge in 2 foot circular conduits SWMM CRADA Example 1  
**Location:** `SWMM5_NCIMM/STEEP_drop_example_2_SW5.INP`
...
---
<sub>📄 Auto-generated 2026-06-24 • summary of `STEEP_drop_example_2_SW5.inp`</sub>
