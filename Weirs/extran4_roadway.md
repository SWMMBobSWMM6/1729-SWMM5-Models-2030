...
> [!CAUTION]
> **Run failed** -- 1 fatal error(s) in `extran4_roadway.rpt`.<br>ERROR 351: cannot open routing interface file D:\SWMMandSoftware\SWMM5.013_June2018\EPASWMM5.1.013\Swmm5.1.013UpdateTests\OWA_EXTRAN\Extran4.txt.

**Title:** Example 4 of Extran Manual - Weir  
**Location:** `Weirs/extran4_roadway.inp`
...
---
<sub>📄 Auto-generated 2026-06-24 • summary of `extran4_roadway.inp`</sub>
