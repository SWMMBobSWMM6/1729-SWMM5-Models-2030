...
> [!NOTE]
> No `RITTIMP.rpt` found next to this model -- it may not have been run yet.

**Title:** Rittiman Road Catchment, San Antonio, Texas.  
**Location:** `XPSWMM/RITTIMP.inp`
...
---
<sub>📄 Auto-generated 2026-06-24 • summary of `RITTIMP.inp`</sub>
