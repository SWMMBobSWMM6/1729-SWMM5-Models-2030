...
> [!NOTE]
> No `MASTER3.rpt` found next to this model -- it may not have been run yet.

**Title:** West Basins Baird MHP  
**Location:** `XPSWMM/MASTER3.inp`
...
---
<sub>📄 Auto-generated 2026-06-24 • summary of `MASTER3.inp`</sub>
