...
> [!NOTE]
> No `RUN24.rpt` found next to this model -- it may not have been run yet.

**Title:** PCSWMM 3.2 EXERCISE 12 - RUNOFF EXAMPLE # 24  
**Location:** `XPSWMM/RUN24.inp`
...
---
<sub>📄 Auto-generated 2026-06-24 • summary of `RUN24.inp`</sub>
