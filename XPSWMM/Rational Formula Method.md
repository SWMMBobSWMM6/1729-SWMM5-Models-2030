...
> [!NOTE]
> No `Rational Formula Method.rpt` found next to this model -- it may not have been run yet.

**Title:** Converted from XPSWMM .xp file  
**Location:** `XPSWMM/Rational Formula Method.inp`
...
---
<sub>📄 Auto-generated 2026-06-24 • summary of `Rational Formula Method.inp`</sub>
