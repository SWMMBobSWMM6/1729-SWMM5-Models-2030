...
> [!NOTE]
> No `EROSBOD.rpt` found next to this model -- it may not have been run yet.

**Title:** RUNOFF EXAMPLE # 23 - A WIDE PARABOLIC CHANNEL BETWEEN 301 AND 201  
**Location:** `XPSWMM/EROSBOD.inp`
...
---
<sub>📄 Auto-generated 2026-06-24 • summary of `EROSBOD.inp`</sub>
