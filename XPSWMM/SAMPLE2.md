...
> [!NOTE]
> No `SAMPLE2.rpt` found next to this model -- it may not have been run yet.

**Title:** Lexington Expansion Area 2A, B, and C  
**Location:** `XPSWMM/SAMPLE2.inp`
...
---
<sub>📄 Auto-generated 2026-06-24 • summary of `SAMPLE2.inp`</sub>
