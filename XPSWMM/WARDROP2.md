...
> [!NOTE]
> No `WARDROP2.rpt` found next to this model -- it may not have been run yet.

**Title:** Polson District - Diversion Analysis  
**Location:** `XPSWMM/WARDROP2.inp`
...
---
<sub>📄 Auto-generated 2026-06-24 • summary of `WARDROP2.inp`</sub>
