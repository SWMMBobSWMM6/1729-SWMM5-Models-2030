...
> [!NOTE]
> No `PEARCE1.rpt` found next to this model -- it may not have been run yet.

**Title:** Converted from XPSWMM .xp file  
**Location:** `XPSWMM/PEARCE1.inp`
...
---
<sub>📄 Auto-generated 2026-06-24 • summary of `PEARCE1.inp`</sub>
