...
> [!NOTE]
> No `Rational_method.rpt` found next to this model -- it may not have been run yet.

**Title:** Rational Formula Example  
**Location:** `XPSWMM/Rational_method.inp`
...
---
<sub>📄 Auto-generated 2026-06-24 • summary of `Rational_method.inp`</sub>
