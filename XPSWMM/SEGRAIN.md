...
> [!NOTE]
> No `SEGRAIN.rpt` found next to this model -- it may not have been run yet.

**Title:** RUNOFF example: parabolic channels, groundwater, water quality  
**Location:** `XPSWMM/SEGRAIN.inp`
...
---
<sub>📄 Auto-generated 2026-06-24 • summary of `SEGRAIN.inp`</sub>
