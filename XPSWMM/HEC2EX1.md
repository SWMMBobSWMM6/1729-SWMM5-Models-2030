...
> [!NOTE]
> No `HEC2EX1.rpt` found next to this model -- it may not have been run yet.

**Title:** Road Crossing with a single box culvert example from HEC-2.  
**Location:** `XPSWMM/HEC2EX1.inp`
...
---
<sub>📄 Auto-generated 2026-06-24 • summary of `HEC2EX1.inp`</sub>
