...
> [!NOTE]
> No `1D Model.rpt` found next to this model -- it may not have been run yet.

**Title:** Converted from XPSWMM .xp file  
**Location:** `XPSWMM/1D Model.inp`
...
---
<sub>📄 Auto-generated 2026-06-24 • summary of `1D Model.inp`</sub>
