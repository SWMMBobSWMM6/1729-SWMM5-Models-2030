...
> [!NOTE]
> No `Quickqa.rpt` found next to this model -- it may not have been run yet.

**Title:** Converted from XPSWMM .xp file  
**Location:** `XPSWMM/Quickqa.inp`
...
---
<sub>📄 Auto-generated 2026-06-24 • summary of `Quickqa.inp`</sub>
