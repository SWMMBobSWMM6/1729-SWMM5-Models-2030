# 💧 M18-1D2D Culvert_complete_final.inp
...
> [!NOTE]
> No `M18-1D2D Culvert_complete_final.rpt` found next to this model -- it may not have been run yet.

**Title:** Converted from XPSWMM .xp file  
**Location:** `XPSWMM/M18-1D2D Culvert_complete_final.inp`
...
---
<sub>📄 Auto-generated 2026-06-24 • summary of `M18-1D2D Culvert_complete_final.inp`</sub>
