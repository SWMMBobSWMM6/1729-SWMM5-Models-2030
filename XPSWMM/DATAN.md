...
> [!NOTE]
> No `DATAN.rpt` found next to this model -- it may not have been run yet.

**Title:** Nodal Test of Snowmelt  
**Location:** `XPSWMM/DATAN.inp`
...
---
<sub>📄 Auto-generated 2026-06-24 • summary of `DATAN.inp`</sub>
