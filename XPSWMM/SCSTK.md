...
> [!NOTE]
> No `SCSTK.rpt` found next to this model -- it may not have been run yet.

**Title:** Scs Example for Brookville  
**Location:** `XPSWMM/SCSTK.inp`
...
---
<sub>📄 Auto-generated 2026-06-24 • summary of `SCSTK.inp`</sub>
