...
> [!NOTE]
> No `SIMPLE.rpt` found next to this model -- it may not have been run yet.

**Title:** BOYLE/SYDICATE CSR - SWMM Model Simulation  
**Location:** `XPSWMM/SIMPLE.inp`
...
---
<sub>📄 Auto-generated 2026-06-24 • summary of `SIMPLE.inp`</sub>
