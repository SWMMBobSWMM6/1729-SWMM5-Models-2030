...
> [!NOTE]
> No `RCONFLU.rpt` found next to this model -- it may not have been run yet.

**Title:** Example of runoff confluence using wieghted areas for dividing  
**Location:** `XPSWMM/RCONFLU.inp`
...
---
<sub>📄 Auto-generated 2026-06-24 • summary of `RCONFLU.inp`</sub>
