...
> [!NOTE]
> No `EAXMPL2.rpt` found next to this model -- it may not have been run yet.

**Title:** Example 2  
**Location:** `XPSWMM/EAXMPL2.inp`
...
---
<sub>📄 Auto-generated 2026-06-24 • summary of `EAXMPL2.inp`</sub>
