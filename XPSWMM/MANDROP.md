...
> [!NOTE]
> No `MANDROP.rpt` found next to this model -- it may not have been run yet.

**Title:** Converted from XPSWMM .xp file  
**Location:** `XPSWMM/MANDROP.inp`
...
---
<sub>📄 Auto-generated 2026-06-24 • summary of `MANDROP.inp`</sub>
