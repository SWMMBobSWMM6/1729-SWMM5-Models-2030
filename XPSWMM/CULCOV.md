...
> [!NOTE]
> No `CULCOV.rpt` found next to this model -- it may not have been run yet.

**Title:** Culvert Example  
**Location:** `XPSWMM/CULCOV.inp`
...
---
<sub>📄 Auto-generated 2026-06-24 • summary of `CULCOV.inp`</sub>
