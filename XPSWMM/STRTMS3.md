...
> [!NOTE]
> No `STRTMS3.rpt` found next to this model -- it may not have been run yet.

**Title:** Storage/Treatment Master Example  
**Location:** `XPSWMM/STRTMS3.inp`
...
---
<sub>📄 Auto-generated 2026-06-24 • summary of `STRTMS3.inp`</sub>
