...
> [!NOTE]
> No `SCS Storms.rpt` found next to this model -- it may not have been run yet.

**Title:** Converted from XPSWMM .xp file  
**Location:** `XPSWMM/SCS Storms.inp`
...
---
<sub>📄 Auto-generated 2026-06-24 • summary of `SCS Storms.inp`</sub>
