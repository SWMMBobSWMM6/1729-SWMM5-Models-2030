...
> [!NOTE]
> No `TRSAM1.rpt` found next to this model -- it may not have been run yet.

**Title:** Simple Example for Testing  
**Location:** `XPSWMM/TRSAM1.inp`
...
---
<sub>📄 Auto-generated 2026-06-24 • summary of `TRSAM1.inp`</sub>
