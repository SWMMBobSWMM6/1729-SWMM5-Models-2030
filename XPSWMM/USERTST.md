...
> [!NOTE]
> No `USERTST.rpt` found next to this model -- it may not have been run yet.

**Title:** CATCHMENT TRIBUTARY TO MONITOR 20.  USING OVERSIZED CHANNEL & ORIFICE  
**Location:** `XPSWMM/USERTST.inp`
...
---
<sub>📄 Auto-generated 2026-06-24 • summary of `USERTST.inp`</sub>
