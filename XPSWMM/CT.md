...
> [!NOTE]
> No `CT.rpt` found next to this model -- it may not have been run yet.

**Title:** Converted from XPSWMM .xp file  
**Location:** `XPSWMM/CT.inp`
...
| Routing step | 00:00:180 s |

## 🔧 Hydraulics

| Nodes | Count | Links | Count |
|---|--:|---|--:|
| Junctions | 40 | Conduits | 44 |
| Outfalls | 0 | Pumps | 3 |
...
---
<sub>📄 Auto-generated 2026-06-24 • summary of `CT.inp`</sub>
