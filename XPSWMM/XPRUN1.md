...
> [!NOTE]
> No `XPRUN1.rpt` found next to this model -- it may not have been run yet.

**Title:** RUNOFF EXAMPLE 36 - USER DEFINED PRECIPITATION  
**Location:** `XPSWMM/XPRUN1.inp`
...
---
<sub>📄 Auto-generated 2026-06-24 • summary of `XPRUN1.inp`</sub>
