...
> [!NOTE]
> No `TESTEXT1.rpt` found next to this model -- it may not have been run yet.

**Title:** Example 1  
**Location:** `XPSWMM/TESTEXT1.inp`
...
---
<sub>📄 Auto-generated 2026-06-24 • summary of `TESTEXT1.inp`</sub>
