...
> [!NOTE]
> No `trans_nc.rpt` found next to this model -- it may not have been run yet.

**Title:** Converted from XPSWMM .xp file  
**Location:** `XPSWMM/trans_nc.inp`
...
---
<sub>📄 Auto-generated 2026-06-24 • summary of `trans_nc.inp`</sub>
