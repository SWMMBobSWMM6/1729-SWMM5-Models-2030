...
> [!NOTE]
> No `ERPONDS.rpt` found next to this model -- it may not have been run yet.

**Title:** English Ranch South - Pond Interconnection and Outlet System  
**Location:** `XPSWMM/ERPONDS.inp`
...
---
<sub>📄 Auto-generated 2026-06-24 • summary of `ERPONDS.inp`</sub>
