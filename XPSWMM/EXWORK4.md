...
> [!NOTE]
> No `EXWORK4.rpt` found next to this model -- it may not have been run yet.

**Title:** Converted from XPSWMM .xp file  
**Location:** `XPSWMM/EXWORK4.inp`
...
---
<sub>📄 Auto-generated 2026-06-24 • summary of `EXWORK4.inp`</sub>
