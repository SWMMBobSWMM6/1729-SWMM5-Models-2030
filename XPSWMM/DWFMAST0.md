...
> [!NOTE]
> No `DWFMAST0.rpt` found next to this model -- it may not have been run yet.

**Title:** Converted from XPSWMM .xp file  
**Location:** `XPSWMM/DWFMAST0.inp`
...
---
<sub>📄 Auto-generated 2026-06-24 • summary of `DWFMAST0.inp`</sub>
