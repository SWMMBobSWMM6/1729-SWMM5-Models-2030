...
> [!NOTE]
> No `REXAM1.rpt` found next to this model -- it may not have been run yet.

**Title:** simple runoff example  
**Location:** `XPSWMM/REXAM1.inp`
...
---
<sub>📄 Auto-generated 2026-06-24 • summary of `REXAM1.inp`</sub>
