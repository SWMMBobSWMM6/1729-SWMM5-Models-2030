...
> [!NOTE]
> No `coco1.rpt` found next to this model -- it may not have been run yet.

**Title:** Broward County NADA Study Model  
**Location:** `XPSWMM/coco1.inp`
...
---
<sub>📄 Auto-generated 2026-06-24 • summary of `coco1.inp`</sub>
