...
> [!NOTE]
> No `T2.rpt` found next to this model -- it may not have been run yet.

**Title:** This is an XPX file for building Test2ext.xp  
**Location:** `XPSWMM/T2.inp`
...
---
<sub>📄 Auto-generated 2026-06-24 • summary of `T2.inp`</sub>
