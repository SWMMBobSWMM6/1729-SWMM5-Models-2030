...
> [!NOTE]
> No `EXWORK5.rpt` found next to this model -- it may not have been run yet.

**Title:** Converted from XPSWMM .xp file  
**Location:** `XPSWMM/EXWORK5.inp`
...
---
<sub>📄 Auto-generated 2026-06-24 • summary of `EXWORK5.inp`</sub>
