...
> [!NOTE]
> No `TESTEXT2.rpt` found next to this model -- it may not have been run yet.

**Title:** Example 2  
**Location:** `XPSWMM/TESTEXT2.inp`
...
---
<sub>📄 Auto-generated 2026-06-24 • summary of `TESTEXT2.inp`</sub>
