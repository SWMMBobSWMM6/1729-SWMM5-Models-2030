...
> [!NOTE]
> No `FLAPTST.rpt` found next to this model -- it may not have been run yet.

**Title:** EXTRAN - User-defined Conduits  
**Location:** `XPSWMM/FLAPTST.inp`
...
---
<sub>📄 Auto-generated 2026-06-24 • summary of `FLAPTST.inp`</sub>
