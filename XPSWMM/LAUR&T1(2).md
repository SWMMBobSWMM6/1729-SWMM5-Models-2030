...
> [!NOTE]
> No `LAUR&T1(2).rpt` found next to this model -- it may not have been run yet.

**Title:** Converted from XPSWMM .xp file  
**Location:** `XPSWMM/LAUR&T1(2).inp`
...
---
<sub>📄 Auto-generated 2026-06-24 • summary of `LAUR&T1(2).inp`</sub>
