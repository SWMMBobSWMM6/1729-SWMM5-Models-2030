...
> [!NOTE]
> No `LexingtonEvent.rpt` found next to this model -- it may not have been run yet.

**Title:** LFUCG Default  Database - Created by XP Software  
**Location:** `XPSWMM/LexingtonEvent.inp`
...
---
<sub>📄 Auto-generated 2026-06-24 • summary of `LexingtonEvent.inp`</sub>
