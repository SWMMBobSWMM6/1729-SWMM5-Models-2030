# 💧 san_antonio_five_pipe_network.inp
...
> [!NOTE]
> No `san_antonio_five_pipe_network.rpt` found next to this model -- it may not have been run yet.

**Title:** Flow = 141 MGD (all scenarios)  
**Location:** `XPSWMM/san_antonio_five_pipe_network.inp`
...
---
<sub>📄 Auto-generated 2026-06-24 • summary of `san_antonio_five_pipe_network.inp`</sub>
