...
> [!NOTE]
> No `WARDR1.rpt` found next to this model -- it may not have been run yet.

**Title:** Munroe and Polson Districts - Diversion Analysis  
**Location:** `XPSWMM/WARDR1.inp`
...
---
<sub>📄 Auto-generated 2026-06-24 • summary of `WARDR1.inp`</sub>
