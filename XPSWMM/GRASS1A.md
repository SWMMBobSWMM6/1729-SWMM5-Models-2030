...
> [!NOTE]
> No `GRASS1A.rpt` found next to this model -- it may not have been run yet.

**Title:** SWMM MODEL REPRODUCTION FOR THE SNAIL LAKE WATERSHED  
**Location:** `XPSWMM/GRASS1A.inp`
...
---
<sub>📄 Auto-generated 2026-06-24 • summary of `GRASS1A.inp`</sub>
