...
> [!NOTE]
> No `Edmonton_Master.rpt` found next to this model -- it may not have been run yet.

**Title:** 1st Optional Title  
**Location:** `XPSWMM/Edmonton_Master.inp`
...
---
<sub>📄 Auto-generated 2026-06-24 • summary of `Edmonton_Master.inp`</sub>
