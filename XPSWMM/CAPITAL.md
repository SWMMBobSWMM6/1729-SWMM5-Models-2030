...
> [!NOTE]
> No `CAPITAL.rpt` found next to this model -- it may not have been run yet.

**Title:** Converted from XPSWMM .xp file  
**Location:** `XPSWMM/CAPITAL.inp`
...
---
<sub>📄 Auto-generated 2026-06-24 • summary of `CAPITAL.inp`</sub>
