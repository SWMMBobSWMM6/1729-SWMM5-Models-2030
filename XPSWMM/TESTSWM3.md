...
> [!NOTE]
> No `TESTSWM3.rpt` found next to this model -- it may not have been run yet.

**Title:** Example 1  
**Location:** `XPSWMM/TESTSWM3.inp`
...
---
<sub>📄 Auto-generated 2026-06-24 • summary of `TESTSWM3.inp`</sub>
