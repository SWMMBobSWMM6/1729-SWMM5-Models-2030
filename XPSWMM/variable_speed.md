...
> [!NOTE]
> No `variable_speed.rpt` found next to this model -- it may not have been run yet.

**Title:** Example 2  
**Location:** `XPSWMM/variable_speed.inp`
...
---
<sub>📄 Auto-generated 2026-06-24 • summary of `variable_speed.inp`</sub>
