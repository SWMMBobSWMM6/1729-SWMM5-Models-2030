...
> [!NOTE]
> No `GWNODE.rpt` found next to this model -- it may not have been run yet.

**Title:** RUNOFF EXAMPLE 26, PARABOLIC CHANNELS, GROUNDWATER  
**Location:** `XPSWMM/GWNODE.inp`
...
---
<sub>📄 Auto-generated 2026-06-24 • summary of `GWNODE.inp`</sub>
