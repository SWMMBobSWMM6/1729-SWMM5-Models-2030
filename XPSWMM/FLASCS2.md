...
> [!NOTE]
> No `FLASCS2.rpt` found next to this model -- it may not have been run yet.

**Title:** Comparison of common SCS shape factors  
**Location:** `XPSWMM/FLASCS2.inp`
...
---
<sub>📄 Auto-generated 2026-06-24 • summary of `FLASCS2.inp`</sub>
