...
> [!NOTE]
> No `STRTMAS.rpt` found next to this model -- it may not have been run yet.

**Title:** Storage/Treatment Master Example  
**Location:** `XPSWMM/STRTMAS.inp`
...
---
<sub>📄 Auto-generated 2026-06-24 • summary of `STRTMAS.inp`</sub>
