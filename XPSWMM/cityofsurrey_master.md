...
> [!NOTE]
> No `cityofsurrey_master.rpt` found next to this model -- it may not have been run yet.

**Title:** City of Surrey Master File - created by XP Software, Inc.  
**Location:** `XPSWMM/cityofsurrey_master.inp`
...
---
<sub>📄 Auto-generated 2026-06-24 • summary of `cityofsurrey_master.inp`</sub>
