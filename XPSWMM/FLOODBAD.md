...
> [!NOTE]
> No `FLOODBAD.rpt` found next to this model -- it may not have been run yet.

**Title:** Flooded Node Comparison with XP-SWMM  
**Location:** `XPSWMM/FLOODBAD.inp`
...
---
<sub>📄 Auto-generated 2026-06-24 • summary of `FLOODBAD.inp`</sub>
