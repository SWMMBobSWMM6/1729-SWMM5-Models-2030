...
> [!NOTE]
> No `STRTHB.rpt` found next to this model -- it may not have been run yet.

**Title:** Example XP Strt # 1  
**Location:** `XPSWMM/STRTHB.inp`
...
---
<sub>📄 Auto-generated 2026-06-24 • summary of `STRTHB.inp`</sub>
