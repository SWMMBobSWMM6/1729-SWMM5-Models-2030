...
> [!NOTE]
> No `WEIRTEST.rpt` found next to this model -- it may not have been run yet.

**Title:** Kuykendahl Road - Ultimate Section - Concrete Curb and Gutter  
**Location:** `XPSWMM/WEIRTEST.inp`
...
---
<sub>📄 Auto-generated 2026-06-24 • summary of `WEIRTEST.inp`</sub>
