...
> [!NOTE]
> No `TESTREG.rpt` found next to this model -- it may not have been run yet.

**Title:** Test of Regulator Link/Inflatable Weir  
**Location:** `XPSWMM/TESTREG.inp`
...
---
<sub>📄 Auto-generated 2026-06-24 • summary of `TESTREG.inp`</sub>
