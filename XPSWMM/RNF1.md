...
> [!NOTE]
> No `RNF1.rpt` found next to this model -- it may not have been run yet.

**Title:** Runoff Example  
**Location:** `XPSWMM/RNF1.inp`
...
---
<sub>📄 Auto-generated 2026-06-24 • summary of `RNF1.inp`</sub>
