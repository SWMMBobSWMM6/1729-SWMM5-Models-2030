...
> [!NOTE]
> No `French_Drains.rpt` found next to this model -- it may not have been run yet.

**Title:** Converted from XPSWMM .xp file  
**Location:** `XPSWMM/French_Drains.inp`
...
---
<sub>📄 Auto-generated 2026-06-24 • summary of `French_Drains.inp`</sub>
