...
> [!NOTE]
> No `FLASCS1.rpt` found next to this model -- it may not have been run yet.

**Title:** Comparison of common SCS shape factors  
**Location:** `XPSWMM/FLASCS1.inp`
...
---
<sub>📄 Auto-generated 2026-06-24 • summary of `FLASCS1.inp`</sub>
