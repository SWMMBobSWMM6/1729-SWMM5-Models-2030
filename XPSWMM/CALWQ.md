...
> [!NOTE]
> No `CALWQ.rpt` found next to this model -- it may not have been run yet.

**Title:** EMC for WQ at node Watershed  
**Location:** `XPSWMM/CALWQ.inp`
...
---
<sub>📄 Auto-generated 2026-06-24 • summary of `CALWQ.inp`</sub>
