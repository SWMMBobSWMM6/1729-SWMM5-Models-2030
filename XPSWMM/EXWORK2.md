...
> [!NOTE]
> No `EXWORK2.rpt` found next to this model -- it may not have been run yet.

**Title:** Converted from XPSWMM .xp file  
**Location:** `XPSWMM/EXWORK2.inp`
...
---
<sub>📄 Auto-generated 2026-06-24 • summary of `EXWORK2.inp`</sub>
