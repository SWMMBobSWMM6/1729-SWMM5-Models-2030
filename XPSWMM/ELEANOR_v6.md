...
> [!NOTE]
> No `ELEANOR_v6.rpt` found next to this model -- it may not have been run yet.

**Title:** Converted from XPSWMM .xp file  
**Location:** `XPSWMM/ELEANOR_v6.inp`
...
---
<sub>📄 Auto-generated 2026-06-24 • summary of `ELEANOR_v6.inp`</sub>
