...
> [!NOTE]
> No `EXSYPH.rpt` found next to this model -- it may not have been run yet.

**Title:** Delta Sanitary Sewer Project Syphon  
**Location:** `XPSWMM/EXSYPH.inp`
...
---
<sub>📄 Auto-generated 2026-06-24 • summary of `EXSYPH.inp`</sub>
