...
> [!NOTE]
> No `RationalFormulawithIDF.rpt` found next to this model -- it may not have been run yet.

**Title:** Rational Formula Example  
**Location:** `XPSWMM/RationalFormulawithIDF.inp`
...
---
<sub>📄 Auto-generated 2026-06-24 • summary of `RationalFormulawithIDF.inp`</sub>
