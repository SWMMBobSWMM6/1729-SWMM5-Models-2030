...
> [!NOTE]
> No `HASAN1.rpt` found next to this model -- it may not have been run yet.

**Title:** NO3 + NO2 AS NO3 AT STATION "C" ON FEBRUARY 20, 1996  
**Location:** `XPSWMM/HASAN1.inp`
...
---
<sub>📄 Auto-generated 2026-06-24 • summary of `HASAN1.inp`</sub>
