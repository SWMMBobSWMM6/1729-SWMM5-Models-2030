...
> [!NOTE]
> No `baseball.rpt` found next to this model -- it may not have been run yet.

**Title:** Converted from XPSWMM .xp file  
**Location:** `XPSWMM/baseball.inp`
...
---
<sub>📄 Auto-generated 2026-06-24 • summary of `baseball.inp`</sub>
