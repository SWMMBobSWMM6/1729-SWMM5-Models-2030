...
> [!NOTE]
> No `ALLTUT7.rpt` found next to this model -- it may not have been run yet.

**Title:** Converted from XPSWMM .xp file  
**Location:** `XPSWMM/ALLTUT7.inp`
...
---
<sub>📄 Auto-generated 2026-06-24 • summary of `ALLTUT7.inp`</sub>
