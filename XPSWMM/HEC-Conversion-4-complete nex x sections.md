# 💧 HEC-Conversion-4-complete nex x sections.inp
...
> [!NOTE]
> No `HEC-Conversion-4-complete nex x sections.rpt` found next to this model -- it may not have been run yet.

**Title:** Converted from XPSWMM .xp file  
**Location:** `XPSWMM/HEC-Conversion-4-complete nex x sections.inp`
...
---
<sub>📄 Auto-generated 2026-06-24 • summary of `HEC-Conversion-4-complete nex x sections.inp`</sub>
