...
> [!NOTE]
> No `LexingtonContinuous.rpt` found next to this model -- it may not have been run yet.

**Title:** LFUCG Default  Database - Created by XP Software  
**Location:** `XPSWMM/LexingtonContinuous.inp`
...
---
<sub>📄 Auto-generated 2026-06-24 • summary of `LexingtonContinuous.inp`</sub>
