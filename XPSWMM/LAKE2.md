...
> [!NOTE]
> No `LAKE2.rpt` found next to this model -- it may not have been run yet.

**Title:** first test run using Hosmer and Wards lakes' level as input  
**Location:** `XPSWMM/LAKE2.inp`
...
---
<sub>📄 Auto-generated 2026-06-24 • summary of `LAKE2.inp`</sub>
