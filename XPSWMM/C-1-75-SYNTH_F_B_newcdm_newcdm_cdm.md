# 💧 C-1-75-SYNTH_F_B_newcdm_newcdm_cdm.inp
...
> [!NOTE]
> No `C-1-75-SYNTH_F_B_newcdm_newcdm_cdm.rpt` found next to this model -- it may not have been run yet.

**Title:** C-1 CALIBRATION 1994  
**Location:** `XPSWMM/C-1-75-SYNTH_F_B_newcdm_newcdm_cdm.inp`
...
---
<sub>📄 Auto-generated 2026-06-24 • summary of `C-1-75-SYNTH_F_B_newcdm_newcdm_cdm.inp`</sub>
