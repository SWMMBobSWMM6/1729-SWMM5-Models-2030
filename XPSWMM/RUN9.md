...
> [!NOTE]
> No `RUN9.rpt` found next to this model -- it may not have been run yet.

**Title:** PCSWMM 3.2 EXERCISE 1A  
**Location:** `XPSWMM/RUN9.inp`
...
---
<sub>📄 Auto-generated 2026-06-24 • summary of `RUN9.inp`</sub>
