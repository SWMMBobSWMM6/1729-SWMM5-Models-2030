...
> [!NOTE]
> No `BLAKE.rpt` found next to this model -- it may not have been run yet.

**Title:** Bitter Lake Drainage analysis - existing conditions - RBHLAKE  
**Location:** `XPSWMM/BLAKE.inp`
...
---
<sub>📄 Auto-generated 2026-06-24 • summary of `BLAKE.inp`</sub>
