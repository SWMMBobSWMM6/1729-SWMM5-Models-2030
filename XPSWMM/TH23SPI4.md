...
> [!NOTE]
> No `TH23SPI4.rpt` found next to this model -- it may not have been run yet.

**Title:** Basic First Runoff Try  
**Location:** `XPSWMM/TH23SPI4.inp`
...
---
<sub>📄 Auto-generated 2026-06-24 • summary of `TH23SPI4.inp`</sub>
