...
> [!NOTE]
> No `TESTCDM.rpt` found next to this model -- it may not have been run yet.

**Title:** Converted from XPSWMM .xp file  
**Location:** `XPSWMM/TESTCDM.inp`
...
---
<sub>📄 Auto-generated 2026-06-24 • summary of `TESTCDM.inp`</sub>
