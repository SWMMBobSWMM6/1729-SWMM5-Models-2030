...
> [!NOTE]
> No `LOCALT3.rpt` found next to this model -- it may not have been run yet.

**Title:** SQUAW PEAK OUTER LOOP INTERCHANGE DRAINAGE STUDY  
**Location:** `XPSWMM/LOCALT3.inp`
...
---
<sub>📄 Auto-generated 2026-06-24 • summary of `LOCALT3.inp`</sub>
