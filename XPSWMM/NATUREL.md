...
> [!NOTE]
> No `NATUREL.rpt` found next to this model -- it may not have been run yet.

**Title:** SCS Distrubution Test  
**Location:** `XPSWMM/NATUREL.inp`
...
---
<sub>📄 Auto-generated 2026-06-24 • summary of `NATUREL.inp`</sub>
