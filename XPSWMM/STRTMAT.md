...
> [!NOTE]
> No `STRTMAT.rpt` found next to this model -- it may not have been run yet.

**Title:** Storage/Treatment Master Example  
**Location:** `XPSWMM/STRTMAT.inp`
...
---
<sub>📄 Auto-generated 2026-06-24 • summary of `STRTMAT.inp`</sub>
