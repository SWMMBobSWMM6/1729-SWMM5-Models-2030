...
> [!NOTE]
> No `SCSCOMP1.rpt` found next to this model -- it may not have been run yet.

**Title:** Dukes Bay in Valdosta, Georgia - Runoff Results  
**Location:** `XPSWMM/SCSCOMP1.inp`
...
---
<sub>📄 Auto-generated 2026-06-24 • summary of `SCSCOMP1.inp`</sub>
