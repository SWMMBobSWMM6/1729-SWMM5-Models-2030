...
> [!NOTE]
> No `Saskatoon_Master.rpt` found next to this model -- it may not have been run yet.

**Title:** 1st Optional Title  
**Location:** `XPSWMM/Saskatoon_Master.inp`
...
---
<sub>📄 Auto-generated 2026-06-24 • summary of `Saskatoon_Master.inp`</sub>
