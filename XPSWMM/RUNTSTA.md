...
> [!NOTE]
> No `RUNTSTA.rpt` found next to this model -- it may not have been run yet.

**Title:** Converted from XPSWMM .xp file  
**Location:** `XPSWMM/RUNTSTA.inp`
...
---
<sub>📄 Auto-generated 2026-06-24 • summary of `RUNTSTA.inp`</sub>
