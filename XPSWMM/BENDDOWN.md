...
> [!NOTE]
> No `BENDDOWN.rpt` found next to this model -- it may not have been run yet.

**Title:** A Test on the Bendable Weir Feature  
**Location:** `XPSWMM/BENDDOWN.inp`
...
---
<sub>📄 Auto-generated 2026-06-24 • summary of `BENDDOWN.inp`</sub>
