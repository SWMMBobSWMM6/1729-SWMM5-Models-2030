...
> [!NOTE]
> No `UDSPLIT.rpt` found next to this model -- it may not have been run yet.

**Title:** udd down with basin and rafts routing  
**Location:** `XPSWMM/UDSPLIT.inp`
...
---
<sub>📄 Auto-generated 2026-06-24 • summary of `UDSPLIT.inp`</sub>
