...
> [!NOTE]
> No `RUN8.rpt` found next to this model -- it may not have been run yet.

**Title:** RUNOFF EXAMPLE 8, PARABOLIC CHANNELS, NO GROUNDWATER  
**Location:** `XPSWMM/RUN8.inp`
...
---
<sub>📄 Auto-generated 2026-06-24 • summary of `RUN8.inp`</sub>
