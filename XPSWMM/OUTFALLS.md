...
> [!NOTE]
> No `OUTFALLS.rpt` found next to this model -- it may not have been run yet.

**Title:** EXTRAN USER'S MANUAL EXAMPLE PROBLEM 43.  
**Location:** `XPSWMM/OUTFALLS.inp`
...
---
<sub>📄 Auto-generated 2026-06-24 • summary of `OUTFALLS.inp`</sub>
