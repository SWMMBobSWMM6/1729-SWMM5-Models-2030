...
> [!NOTE]
> No `SCSCOMP.rpt` found next to this model -- it may not have been run yet.

**Title:** Dukes Bay in Valdosta, Georgia - Runoff Results  
**Location:** `XPSWMM/SCSCOMP.inp`
...
---
<sub>📄 Auto-generated 2026-06-24 • summary of `SCSCOMP.inp`</sub>
