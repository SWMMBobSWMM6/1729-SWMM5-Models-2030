...
> [!NOTE]
> No `kwdw_v6.rpt` found next to this model -- it may not have been run yet.

**Title:** Inverted syphon example from Vanslambrouck et al. (1986)  
**Location:** `XPSWMM/kwdw_v6.inp`
...
---
<sub>📄 Auto-generated 2026-06-24 • summary of `kwdw_v6.inp`</sub>
