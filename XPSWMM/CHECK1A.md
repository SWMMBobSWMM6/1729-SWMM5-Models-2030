...
> [!NOTE]
> No `CHECK1A.rpt` found next to this model -- it may not have been run yet.

**Title:** Converted from XPSWMM .xp file  
**Location:** `XPSWMM/CHECK1A.inp`
...
---
<sub>📄 Auto-generated 2026-06-24 • summary of `CHECK1A.inp`</sub>
