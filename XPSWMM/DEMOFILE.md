...
> [!NOTE]
> No `DEMOFILE.rpt` found next to this model -- it may not have been run yet.

**Title:** Seperate Title Blocks for Each Mode  
**Location:** `XPSWMM/DEMOFILE.inp`
...
---
<sub>📄 Auto-generated 2026-06-24 • summary of `DEMOFILE.inp`</sub>
