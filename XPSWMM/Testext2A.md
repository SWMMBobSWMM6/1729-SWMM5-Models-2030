...
> [!NOTE]
> No `Testext2A.rpt` found next to this model -- it may not have been run yet.

**Title:** Example 2  
**Location:** `XPSWMM/Testext2A.inp`
...
---
<sub>📄 Auto-generated 2026-06-24 • summary of `Testext2A.inp`</sub>
