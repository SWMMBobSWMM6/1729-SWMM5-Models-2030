...
> [!NOTE]
> No `EXAM10.rpt` found next to this model -- it may not have been run yet.

**Title:** EXTRAN USER'S MANUAL EXAMPLE PROBLEM 10. ISOL = 0 SOLUTION.  
**Location:** `XPSWMM/EXAM10.inp`
...
---
<sub>📄 Auto-generated 2026-06-24 • summary of `EXAM10.inp`</sub>
