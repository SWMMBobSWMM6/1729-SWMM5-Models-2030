...
> [!NOTE]
> No `1D-2D_River_starter.rpt` found next to this model -- it may not have been run yet.

**Title:** Converted from XPSWMM .xp file  
**Location:** `XPSWMM/1D-2D_River_starter.inp`
...
---
<sub>📄 Auto-generated 2026-06-24 • summary of `1D-2D_River_starter.inp`</sub>
