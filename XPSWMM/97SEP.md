...
> [!NOTE]
> No `97SEP.rpt` found next to this model -- it may not have been run yet.

**Title:** Rouge River Model for Quality Control Using Storage  
**Location:** `XPSWMM/97SEP.inp`
...
---
<sub>📄 Auto-generated 2026-06-24 • summary of `97SEP.inp`</sub>
