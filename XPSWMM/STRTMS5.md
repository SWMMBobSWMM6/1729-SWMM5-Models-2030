...
> [!NOTE]
> No `STRTMS5.rpt` found next to this model -- it may not have been run yet.

**Title:** Storage/Treatment Master Example  
**Location:** `XPSWMM/STRTMS5.inp`
...
---
<sub>📄 Auto-generated 2026-06-24 • summary of `STRTMS5.inp`</sub>
