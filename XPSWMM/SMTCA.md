...
> [!NOTE]
> No `SMTCA.rpt` found next to this model -- it may not have been run yet.

**Title:** ST MARYS TOWN CENTRE DRAINAGE STUDY MARCH 1993  
**Location:** `XPSWMM/SMTCA.inp`
...
---
<sub>📄 Auto-generated 2026-06-24 • summary of `SMTCA.inp`</sub>
