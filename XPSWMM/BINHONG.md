...
> [!NOTE]
> No `BINHONG.rpt` found next to this model -- it may not have been run yet.

**Title:** AMAZON CREEK BASIN STORM DRAINAGE MODEL - FUTURE LAND USE  
**Location:** `XPSWMM/BINHONG.inp`
...
---
<sub>📄 Auto-generated 2026-06-24 • summary of `BINHONG.inp`</sub>
