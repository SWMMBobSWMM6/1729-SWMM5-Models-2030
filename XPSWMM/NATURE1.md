...
> [!NOTE]
> No `NATURE1.rpt` found next to this model -- it may not have been run yet.

**Title:** SCS DISTRIBUTION TEST  
**Location:** `XPSWMM/NATURE1.inp`
...
---
<sub>📄 Auto-generated 2026-06-24 • summary of `NATURE1.inp`</sub>
