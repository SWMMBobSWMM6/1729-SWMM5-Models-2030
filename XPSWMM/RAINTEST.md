...
> [!NOTE]
> No `RAINTEST.rpt` found next to this model -- it may not have been run yet.

**Title:** Historical Rainfall Test Model  
**Location:** `XPSWMM/RAINTEST.inp`
...
---
<sub>📄 Auto-generated 2026-06-24 • summary of `RAINTEST.inp`</sub>
