...
> [!NOTE]
> No `8_link.rpt` found next to this model -- it may not have been run yet.

**Title:** Transport Simulation - example input file template  
**Location:** `XPSWMM/8_link.inp`
...
---
<sub>📄 Auto-generated 2026-06-24 • summary of `8_link.inp`</sub>
