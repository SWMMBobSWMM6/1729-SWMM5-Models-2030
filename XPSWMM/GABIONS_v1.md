...
> [!NOTE]
> No `GABIONS_v1.rpt` found next to this model -- it may not have been run yet.

**Title:** Converted from XPSWMM .xp file  
**Location:** `XPSWMM/GABIONS_v1.inp`
...
---
<sub>📄 Auto-generated 2026-06-24 • summary of `GABIONS_v1.inp`</sub>
