...
> [!NOTE]
> No `Gwnode1.rpt` found next to this model -- it may not have been run yet.

**Title:** RUNOFF EXAMPLE 26, PARABOLIC CHANNELS, GROUNDWATER  
**Location:** `XPSWMM/Gwnode1.inp`
...
---
<sub>📄 Auto-generated 2026-06-24 • summary of `Gwnode1.inp`</sub>
