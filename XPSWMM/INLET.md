...
> [!NOTE]
> No `INLET.rpt` found next to this model -- it may not have been run yet.

**Title:** Rating Curve Example at Downstream Boundary  
**Location:** `XPSWMM/INLET.inp`
...
---
<sub>📄 Auto-generated 2026-06-24 • summary of `INLET.inp`</sub>
