...
> [!NOTE]
> No `ursrain.rpt` found next to this model -- it may not have been run yet.

**Title:** Converted from XPSWMM .xp file  
**Location:** `XPSWMM/ursrain.inp`
...
---
<sub>📄 Auto-generated 2026-06-24 • summary of `ursrain.inp`</sub>
