...
> [!NOTE]
> No `CHECK1B.rpt` found next to this model -- it may not have been run yet.

**Title:** Converted from XPSWMM .xp file  
**Location:** `XPSWMM/CHECK1B.inp`
...
---
<sub>📄 Auto-generated 2026-06-24 • summary of `CHECK1B.inp`</sub>
