...
> [!NOTE]
> No `USERCOND.rpt` found next to this model -- it may not have been run yet.

**Title:** Converted from XPSWMM .xp file  
**Location:** `XPSWMM/USERCOND.inp`
...
---
<sub>📄 Auto-generated 2026-06-24 • summary of `USERCOND.inp`</sub>
