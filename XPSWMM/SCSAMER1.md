...
> [!NOTE]
> No `SCSAMER1.rpt` found next to this model -- it may not have been run yet.

**Title:** West Basins Baird MHP  
**Location:** `XPSWMM/SCSAMER1.inp`
...
---
<sub>📄 Auto-generated 2026-06-24 • summary of `SCSAMER1.inp`</sub>
