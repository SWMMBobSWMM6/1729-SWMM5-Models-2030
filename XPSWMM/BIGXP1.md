...
> [!NOTE]
> No `BIGXP1.rpt` found next to this model -- it may not have been run yet.

**Title:** RUNOFF EXAMPLE 7, PARABOLIC CHANNELS, GROUNDWATER  
**Location:** `XPSWMM/BIGXP1.inp`
...
---
<sub>📄 Auto-generated 2026-06-24 • summary of `BIGXP1.inp`</sub>
