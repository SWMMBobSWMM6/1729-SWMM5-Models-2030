...
> [!NOTE]
> No `rainminn.rpt` found next to this model -- it may not have been run yet.

**Title:** Converted from XPSWMM .xp file  
**Location:** `XPSWMM/rainminn.inp`
...
---
<sub>📄 Auto-generated 2026-06-24 • summary of `rainminn.inp`</sub>
