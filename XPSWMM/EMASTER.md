...
> [!NOTE]
> No `EMASTER.rpt` found next to this model -- it may not have been run yet.

**Title:** CAiCE Visual Hydro US Unit Default Database  
**Location:** `XPSWMM/EMASTER.inp`
...
---
<sub>📄 Auto-generated 2026-06-24 • summary of `EMASTER.inp`</sub>
