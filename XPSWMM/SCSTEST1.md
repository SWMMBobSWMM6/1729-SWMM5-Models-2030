...
> [!NOTE]
> No `SCSTEST1.rpt` found next to this model -- it may not have been run yet.

**Title:** West Basins Baird MHP  
**Location:** `XPSWMM/SCSTEST1.inp`
...
---
<sub>📄 Auto-generated 2026-06-24 • summary of `SCSTEST1.inp`</sub>
