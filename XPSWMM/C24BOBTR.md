...
> [!NOTE]
> No `C24BOBTR.rpt` found next to this model -- it may not have been run yet.

**Title:** c240004.xp with Little Lake channel and shunt gone; all flank  
**Location:** `XPSWMM/C24BOBTR.inp`
...
---
<sub>📄 Auto-generated 2026-06-24 • summary of `C24BOBTR.inp`</sub>
