...
> [!NOTE]
> No `JUNK2J.rpt` found next to this model -- it may not have been run yet.

**Title:** Monterey Existing Conditions Model  
**Location:** `XPSWMM/JUNK2J.inp`
...
---
<sub>📄 Auto-generated 2026-06-24 • summary of `JUNK2J.inp`</sub>
