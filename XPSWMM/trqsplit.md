...
> [!NOTE]
> No `trqsplit.rpt` found next to this model -- it may not have been run yet.

**Title:** Converted from XPSWMM .xp file  
**Location:** `XPSWMM/trqsplit.inp`
...
---
<sub>📄 Auto-generated 2026-06-24 • summary of `trqsplit.inp`</sub>
