...
> [!NOTE]
> No `SW7.rpt` found next to this model -- it may not have been run yet.

**Title:** Read a metric interface file from the Runoff Block  
**Location:** `XPSWMM/SW7.inp`
...
---
<sub>📄 Auto-generated 2026-06-24 • summary of `SW7.inp`</sub>
