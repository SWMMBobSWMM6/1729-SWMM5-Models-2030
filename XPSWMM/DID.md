...
> [!NOTE]
> No `DID.rpt` found next to this model -- it may not have been run yet.

**Title:** DID Tidal Outlet Example  
**Location:** `XPSWMM/DID.inp`
...
---
<sub>📄 Auto-generated 2026-06-24 • summary of `DID.inp`</sub>
