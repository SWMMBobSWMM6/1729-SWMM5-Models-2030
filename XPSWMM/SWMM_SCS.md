...
> [!NOTE]
> No `SWMM_SCS.rpt` found next to this model -- it may not have been run yet.

**Title:** SWMM AND SCS HYDROLOGY METHODS  
**Location:** `XPSWMM/SWMM_SCS.inp`
...
---
<sub>📄 Auto-generated 2026-06-24 • summary of `SWMM_SCS.inp`</sub>
