...
> [!NOTE]
> No `RUNEXTRN.rpt` found next to this model -- it may not have been run yet.

**Title:** test run, type IA rainfall, dummy outlet  
**Location:** `XPSWMM/RUNEXTRN.inp`
...
---
<sub>📄 Auto-generated 2026-06-24 • summary of `RUNEXTRN.inp`</sub>
