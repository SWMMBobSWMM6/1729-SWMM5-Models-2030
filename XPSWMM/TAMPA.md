...
> [!NOTE]
> No `TAMPA.rpt` found next to this model -- it may not have been run yet.

**Title:** Sweetwater Creek Tampa Florida Workshop Example  
**Location:** `XPSWMM/TAMPA.inp`
...
---
<sub>📄 Auto-generated 2026-06-24 • summary of `TAMPA.inp`</sub>
