...
> [!NOTE]
> No `NEWLINE.rpt` found next to this model -- it may not have been run yet.

**Title:** CAiCE Visual Hydro US Unit Default Database  
**Location:** `XPSWMM/NEWLINE.inp`
...
---
<sub>📄 Auto-generated 2026-06-24 • summary of `NEWLINE.inp`</sub>
