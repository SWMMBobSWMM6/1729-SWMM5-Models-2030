...
> [!NOTE]
> No `RUN35.rpt` found next to this model -- it may not have been run yet.

**Title:** Runoff example # 35 - Conduit depth summary using M4 data group  
**Location:** `XPSWMM/RUN35.inp`
...
---
<sub>📄 Auto-generated 2026-06-24 • summary of `RUN35.inp`</sub>
