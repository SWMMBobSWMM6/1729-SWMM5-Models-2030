...
> [!NOTE]
> No `Design1.rpt` found next to this model -- it may not have been run yet.

**Title:** Design Tools  
**Location:** `XPSWMM/Design1.inp`
...
---
<sub>📄 Auto-generated 2026-06-24 • summary of `Design1.inp`</sub>
