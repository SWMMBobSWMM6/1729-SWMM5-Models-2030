...
> [!NOTE]
> No `EXAM9.rpt` found next to this model -- it may not have been run yet.

**Title:** EXTRAN EXAMPLE 9. FLOW ROUTING THROUGH A DETENTION POND.  
**Location:** `XPSWMM/EXAM9.inp`
...
---
<sub>📄 Auto-generated 2026-06-24 • summary of `EXAM9.inp`</sub>
