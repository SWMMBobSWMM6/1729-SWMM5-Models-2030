...
> [!NOTE]
> No `geopak_master.rpt` found next to this model -- it may not have been run yet.

**Title:** Converted from XPSWMM .xp file  
**Location:** `XPSWMM/geopak_master.inp`
...
---
<sub>📄 Auto-generated 2026-06-24 • summary of `geopak_master.inp`</sub>
