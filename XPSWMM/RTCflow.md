...
> [!NOTE]
> No `RTCflow.rpt` found next to this model -- it may not have been run yet.

**Title:** Example 1  
**Location:** `XPSWMM/RTCflow.inp`
...
---
<sub>📄 Auto-generated 2026-06-24 • summary of `RTCflow.inp`</sub>
