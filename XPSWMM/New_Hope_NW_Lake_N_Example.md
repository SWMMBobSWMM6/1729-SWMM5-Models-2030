# 💧 New_Hope_NW_Lake_N_Example.inp
...
> [!NOTE]
> No `New_Hope_NW_Lake_N_Example.rpt` found next to this model -- it may not have been run yet.

**Title:** Converted from XPSWMM .xp file  
**Location:** `XPSWMM/New_Hope_NW_Lake_N_Example.inp`
...
---
<sub>📄 Auto-generated 2026-06-24 • summary of `New_Hope_NW_Lake_N_Example.inp`</sub>
