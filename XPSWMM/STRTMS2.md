...
> [!NOTE]
> No `STRTMS2.rpt` found next to this model -- it may not have been run yet.

**Title:** Storage/Treatment Master Example  
**Location:** `XPSWMM/STRTMS2.inp`
...
---
<sub>📄 Auto-generated 2026-06-24 • summary of `STRTMS2.inp`</sub>
