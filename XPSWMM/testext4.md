...
> [!NOTE]
> No `testext4.rpt` found next to this model -- it may not have been run yet.

**Title:** Inverted syphon example from Vanslambrouck et al. (1986)  
**Location:** `XPSWMM/testext4.inp`
...
---
<sub>📄 Auto-generated 2026-06-24 • summary of `testext4.inp`</sub>
