...
> [!NOTE]
> No `TESTEXTC.rpt` found next to this model -- it may not have been run yet.

**Title:** Example 1  
**Location:** `XPSWMM/TESTEXTC.inp`
...
---
<sub>📄 Auto-generated 2026-06-24 • summary of `TESTEXTC.inp`</sub>
