...
> [!NOTE]
> No `A-d-Pa.rpt` found next to this model -- it may not have been run yet.

**Title:** HEADLANDS,  DEVELOPED, FIRST FLUSH EVENT FOR AREA "A"  
**Location:** `XPSWMM/A-d-Pa.inp`
...
---
<sub>📄 Auto-generated 2026-06-24 • summary of `A-d-Pa.inp`</sub>
