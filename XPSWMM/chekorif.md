...
> [!NOTE]
> No `chekorif.rpt` found next to this model -- it may not have been run yet.

**Title:** Echelon at Memorial - Culvert & Orifice Sizing for Peak Flow  
**Location:** `XPSWMM/chekorif.inp`
...
---
<sub>📄 Auto-generated 2026-06-24 • summary of `chekorif.inp`</sub>
