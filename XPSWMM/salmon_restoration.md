...
> [!NOTE]
> No `salmon_restoration.rpt` found next to this model -- it may not have been run yet.

**Title:** Converted from XPSWMM .xp file  
**Location:** `XPSWMM/salmon_restoration.inp`
...
---
<sub>📄 Auto-generated 2026-06-24 • summary of `salmon_restoration.inp`</sub>
