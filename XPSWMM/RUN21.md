...
> [!NOTE]
> No `RUN21.rpt` found next to this model -- it may not have been run yet.

**Title:** RUNOFF EXAMPLE # 21 - PCSWMM 3.2 EXERCISE 6  
**Location:** `XPSWMM/RUN21.inp`
...
---
<sub>📄 Auto-generated 2026-06-24 • summary of `RUN21.inp`</sub>
