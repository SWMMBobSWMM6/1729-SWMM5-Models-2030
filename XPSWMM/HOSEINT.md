...
> [!NOTE]
> No `HOSEINT.rpt` found next to this model -- it may not have been run yet.

**Title:** test run, type IA rainfall, dummy outlet  
**Location:** `XPSWMM/HOSEINT.inp`
...
---
<sub>📄 Auto-generated 2026-06-24 • summary of `HOSEINT.inp`</sub>
