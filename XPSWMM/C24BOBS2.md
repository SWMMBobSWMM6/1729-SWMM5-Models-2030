...
> [!NOTE]
> No `C24BOBS2.rpt` found next to this model -- it may not have been run yet.

**Title:** c240004.xp with Little Lake channel and shunt gone; all flank  
**Location:** `XPSWMM/C24BOBS2.inp`
...
---
<sub>📄 Auto-generated 2026-06-24 • summary of `C24BOBS2.inp`</sub>
