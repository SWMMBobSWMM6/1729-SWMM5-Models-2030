# 💧 remote_depth_controlled_pump.inp
...
> [!NOTE]
> No `remote_depth_controlled_pump.rpt` found next to this model -- it may not have been run yet.

**Title:** TRY PUMP NETWORK  
**Location:** `XPSWMM/remote_depth_controlled_pump.inp`
...
---
<sub>📄 Auto-generated 2026-06-24 • summary of `remote_depth_controlled_pump.inp`</sub>
