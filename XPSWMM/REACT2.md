...
> [!NOTE]
> No `REACT2.rpt` found next to this model -- it may not have been run yet.

**Title:** Rating Curve Example at Downstream Boundary  
**Location:** `XPSWMM/REACT2.inp`
...
---
<sub>📄 Auto-generated 2026-06-24 • summary of `REACT2.inp`</sub>
