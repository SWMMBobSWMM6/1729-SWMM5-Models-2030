...
> [!NOTE]
> No `EXQUAL3.rpt` found next to this model -- it may not have been run yet.

**Title:** Converted from XPSWMM .xp file  
**Location:** `XPSWMM/EXQUAL3.inp`
...
---
<sub>📄 Auto-generated 2026-06-24 • summary of `EXQUAL3.inp`</sub>
