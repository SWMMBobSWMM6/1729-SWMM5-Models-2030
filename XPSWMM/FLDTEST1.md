...
> [!NOTE]
> No `FLDTEST1.rpt` found next to this model -- it may not have been run yet.

**Title:** NATURAL CHANNELS WITH VERTICAL WALLS  
**Location:** `XPSWMM/FLDTEST1.inp`
...
---
<sub>📄 Auto-generated 2026-06-24 • summary of `FLDTEST1.inp`</sub>
