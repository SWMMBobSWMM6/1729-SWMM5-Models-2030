...
> [!NOTE]
> No `TRAN2.rpt` found next to this model -- it may not have been run yet.

**Title:** Transport Example 2  
**Location:** `XPSWMM/TRAN2.inp`
...
---
<sub>📄 Auto-generated 2026-06-24 • summary of `TRAN2.inp`</sub>
