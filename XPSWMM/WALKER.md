...
> [!NOTE]
> No `WALKER.rpt` found next to this model -- it may not have been run yet.

**Title:** Runoff with only precipitation input  
**Location:** `XPSWMM/WALKER.inp`
...
---
<sub>📄 Auto-generated 2026-06-24 • summary of `WALKER.inp`</sub>
