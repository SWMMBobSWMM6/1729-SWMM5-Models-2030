...
> [!NOTE]
> No `CAP_NOGG.rpt` found next to this model -- it may not have been run yet.

**Title:** Converted from XPSWMM .xp file  
**Location:** `XPSWMM/CAP_NOGG.inp`
...
---
<sub>📄 Auto-generated 2026-06-24 • summary of `CAP_NOGG.inp`</sub>
