# 💧 Session66_ALL_Outfall_Types.inp
...
> [!TIP]
> Ran clean -- no errors or warnings reported.<br>Continuity error(s): -0.226 %

**Title:** Imported Network from SWMM4 to Test all Outfall Types in SWMM5  
**Location:** `NCIMM_Training/Session_4_50_Examples/Session66_ALL_Outfall_Types.inp`
...
---
<sub>📄 Auto-generated 2026-06-24 • summary of `Session66_ALL_Outfall_Types.inp`</sub>
