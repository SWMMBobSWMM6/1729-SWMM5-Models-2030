# 💧 Session32_w_wo_SWALE_2Subcatchments.inp
...
> [!TIP]
> Ran clean -- no errors or warnings reported.<br>Continuity error(s): -0.015, 0.000 %

**Title:** Example 5 A simple groundwater example.  
**Location:** `NCIMM_Training/Session_4_50_Examples/Session32_w_wo_SWALE_2Subcatchments.inp`
...
---
<sub>📄 Auto-generated 2026-06-24 • summary of `Session32_w_wo_SWALE_2Subcatchments.inp`</sub>
