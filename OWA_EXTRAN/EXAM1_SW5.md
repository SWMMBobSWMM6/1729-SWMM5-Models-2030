...
> [!CAUTION]
> **Run failed** -- 1 fatal error(s) in `EXAM1_SW5.rpt`.<br>ERROR 361: could not open external file used for Time Series INFLOWat82309.

**Title:** SW 1 0 20A1 'EXTRAN USER''S MANUAL EXAMPLE 1'A1 'baseline extran model from  
**Location:** `OWA_EXTRAN/EXAM1_SW5.inp`
...
---
<sub>📄 Auto-generated 2026-06-24 • summary of `EXAM1_SW5.inp`</sub>
