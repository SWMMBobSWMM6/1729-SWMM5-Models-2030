...
> [!WARNING]
> Ran with **1 warning(s)** and no fatal errors.<br>Continuity error(s): -0.054 %

**Title:** Example 6 of Extran Manual - Type 1 Pump  
**Location:** `OWA_EXTRAN/extran6.inp`
...
---
<sub>📄 Auto-generated 2026-06-24 • summary of `extran6.inp`</sub>
