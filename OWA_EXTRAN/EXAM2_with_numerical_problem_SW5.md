# 💧 EXAM2_with_numerical_problem_SW5.inp
...
> [!WARNING]
> Ran with **1 warning(s)** and no fatal errors.<br>Continuity error(s): -0.038 %

**Title:** EXTRAN USER''S MANUAL EXAMPLE 2 BASIC PIPE SYSTEM WITH TIDE GATE FROM FIGURE 3-2  
**Location:** `OWA_EXTRAN/EXAM2_with_numerical_problem_SW5.inp`
...
| Simulation end | 01/01/1988 12:00:00 |
| Duration | 12 hr |
...
---
<sub>📄 Auto-generated 2026-06-24 • summary of `EXAM2_with_numerical_problem_SW5.inp`</sub>
