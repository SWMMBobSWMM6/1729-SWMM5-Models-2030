...
> [!CAUTION]
> **Run failed** -- 1 fatal error(s) in `EXAM1_ICM.rpt`.<br>ERROR 207: duplicate ID name 16009.1 at line 70 of [CONDUIT] section:

**Title:** SW 1 0 20A1 'EXTRAN USER''S MANUAL EXAMPLE 1'A1 'baseline extran model from  
**Location:** `OWA_EXTRAN/EXAM1_ICM.inp`
...
---
<sub>📄 Auto-generated 2026-06-24 • summary of `EXAM1_ICM.inp`</sub>
