# 💧 bug_item11_swmm5.1.014_more_links_than_nodes (1).inp
...
> [!TIP]
> Ran clean -- no errors or warnings reported.<br>Continuity error(s): -0.047 %

**Title:** Example 1 of Extran Manual  
**Location:** `OWA_EXTRAN/bug_item11_swmm5.1.014_more_links_than_nodes (1).inp`
...
---
<sub>📄 Auto-generated 2026-06-24 • summary of `bug_item11_swmm5.1.014_more_links_than_nodes (1).inp`</sub>
