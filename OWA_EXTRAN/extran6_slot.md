...
> [!WARNING]
> Ran with **1 warning(s)** and no fatal errors.<br>Continuity error(s): -0.142 %

**Title:** Example 6 of Extran Manual - Type 1 Pump  
**Location:** `OWA_EXTRAN/extran6_slot.inp`
...
---
<sub>📄 Auto-generated 2026-06-24 • summary of `extran6_slot.inp`</sub>
