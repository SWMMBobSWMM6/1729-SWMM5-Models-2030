...
> [!WARNING]
> Ran with **1 warning(s)** and no fatal errors.<br>Continuity error(s): -0.001 %

**Title:** Example 1 of Extran Manual  
**Location:** `OWA_EXTRAN/mod_extran1.inp`
...
---
<sub>📄 Auto-generated 2026-06-24 • summary of `mod_extran1.inp`</sub>
