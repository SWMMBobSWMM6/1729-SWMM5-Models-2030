# 💧 very_simple_cfs_flow_import_ICM_SWMM.inp
...
> [!TIP]
> Ran clean -- no errors or warnings reported.<br>Continuity error(s): -0.506 %

**Title:** Example 1 of Extran Manual  
**Location:** `OWA_EXTRAN/very_simple_cfs_flow_import_ICM_SWMM.inp`
...
---
<sub>📄 Auto-generated 2026-06-24 • summary of `very_simple_cfs_flow_import_ICM_SWMM.inp`</sub>
