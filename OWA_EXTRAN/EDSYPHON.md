...
> [!WARNING]
> Ran with **2 warning(s)** and no fatal errors.<br>Continuity error(s): 7.044 %

**Title:** Inverted syphon example from Vanslambrouck et al. (1986)  
**Location:** `OWA_EXTRAN/EDSYPHON.inp`
...
| Simulation end | 01/01/1995 01:00:00 |
| Duration | 1 hr |
...
---
<sub>📄 Auto-generated 2026-06-24 • summary of `EDSYPHON.inp`</sub>
