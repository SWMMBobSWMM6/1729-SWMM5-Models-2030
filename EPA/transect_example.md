...
> [!WARNING]
> Ran with **6 warning(s)** and no fatal errors.<br>Continuity error(s): -3.662 %

**Title:** _(no title in [TITLE] section)_  
**Location:** `EPA/transect_example.inp`
...
---
<sub>📄 Auto-generated 2026-06-24 • summary of `transect_example.inp`</sub>
