...
> [!TIP]
> Ran clean -- no errors or warnings reported.<br>Continuity error(s): 3.398 %

**Title:** _(no title in [TITLE] section)_  
**Location:** `EPA/linear_links.inp`
...
---
<sub>📄 Auto-generated 2026-06-24 • summary of `linear_links.inp`</sub>
