...
> [!WARNING]
> Ran with **5 warning(s)** and no fatal errors.<br>Continuity error(s): -0.777 %

**Title:** Scenario Run :  BASE Input and Output FilesSW 1 0 20 Input and Output FilesSW 1 0 20  
**Location:** `EPA/Mater_Extran_Vnotch.inp`
...
---
<sub>📄 Auto-generated 2026-06-24 • summary of `Mater_Extran_Vnotch.inp`</sub>
