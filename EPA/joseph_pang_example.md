...
> [!WARNING]
> Ran with **5 warning(s)** and no fatal errors.<br>Continuity error(s): -0.179 %

**Title:** _(no title in [TITLE] section)_  
**Location:** `EPA/joseph_pang_example.inp`
...
| Simulation start | 04/11/2009 00:00:00 |
| Simulation end | 04/11/2009 02:00:00 |
| Duration | 2 hr |
...
---
<sub>📄 Auto-generated 2026-06-24 • summary of `joseph_pang_example.inp`</sub>
