...
> [!TIP]
> Ran clean -- no errors or warnings reported.<br>Continuity error(s): -0.030 %

**Title:** _(no title in [TITLE] section)_  
**Location:** `EPA/QUICKQ1.inp`
...
---
<sub>📄 Auto-generated 2026-06-24 • summary of `QUICKQ1.inp`</sub>
