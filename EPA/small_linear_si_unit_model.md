# 💧 small_linear_si_unit_model.inp
...
> [!TIP]
> Ran clean -- no errors or warnings reported.<br>Continuity error(s): -0.070 %

**Title:** _(no title in [TITLE] section)_  
**Location:** `EPA/small_linear_si_unit_model.inp`
...
---
<sub>📄 Auto-generated 2026-06-24 • summary of `small_linear_si_unit_model.inp`</sub>
