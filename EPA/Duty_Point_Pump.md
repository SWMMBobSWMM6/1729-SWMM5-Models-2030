...
> [!TIP]
> Ran clean -- no errors or warnings reported.<br>Continuity error(s): -1.172 %

**Title:** _(no title in [TITLE] section)_  
**Location:** `EPA/Duty_Point_Pump.inp`
...
---
<sub>📄 Auto-generated 2026-06-24 • summary of `Duty_Point_Pump.inp`</sub>
