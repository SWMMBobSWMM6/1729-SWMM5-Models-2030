...
> [!TIP]
> Ran clean -- no errors or warnings reported.<br>Continuity error(s): -0.195 %

**Title:** TEST3 DROP WITH SURCHARGE EXAMPLE  
**Location:** `OWA_ROUTING/test3.inp`
...
---
<sub>📄 Auto-generated 2026-06-24 • summary of `test3.inp`</sub>
