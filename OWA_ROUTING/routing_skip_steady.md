...
> [!WARNING]
> Ran with **10 warning(s)** and no fatal errors.<br>Continuity error(s): 4.056 %

**Title:** TEST1 Test SKIP_STEADY_STATE = YES  
**Location:** `OWA_ROUTING/routing_skip_steady.inp`
...
---
<sub>📄 Auto-generated 2026-06-24 • summary of `routing_skip_steady.inp`</sub>
