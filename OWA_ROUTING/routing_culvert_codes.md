...
> [!WARNING]
> Ran with **10 warning(s)** and no fatal errors.<br>Continuity error(s): -0.010 %

**Title:** TEST1 Test CULVERT inlet geometry codes  
**Location:** `OWA_ROUTING/routing_culvert_codes.inp`
...
---
<sub>📄 Auto-generated 2026-06-24 • summary of `routing_culvert_codes.inp`</sub>
