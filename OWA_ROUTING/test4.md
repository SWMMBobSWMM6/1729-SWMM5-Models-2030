...
> [!WARNING]
> Ran with **8 warning(s)** and no fatal errors.<br>Continuity error(s): 0.353 %

**Title:** TEST4 INVERTED SIPHON EXAMPLE  
**Location:** `OWA_ROUTING/test4.inp`
...
---
<sub>📄 Auto-generated 2026-06-24 • summary of `test4.inp`</sub>
