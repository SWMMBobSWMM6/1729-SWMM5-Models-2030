...
> [!WARNING]
> Ran with **10 warning(s)** and no fatal errors.<br>Continuity error(s): -0.003 %

**Title:** TEST1 Test VARIABLE_STEP = 0.75 (CFL-based)  
**Location:** `OWA_ROUTING/routing_variable_step.inp`
...
---
<sub>📄 Auto-generated 2026-06-24 • summary of `routing_variable_step.inp`</sub>
