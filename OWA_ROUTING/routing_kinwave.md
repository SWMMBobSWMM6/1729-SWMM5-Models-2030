...
> [!WARNING]
> Ran with **1 warning(s)** and no fatal errors.<br>Continuity error(s): 0.050 %

**Title:** TEST1 Test KINWAVE routing (never tested)  
**Location:** `OWA_ROUTING/routing_kinwave.inp`
...
---
<sub>📄 Auto-generated 2026-06-24 • summary of `routing_kinwave.inp`</sub>
