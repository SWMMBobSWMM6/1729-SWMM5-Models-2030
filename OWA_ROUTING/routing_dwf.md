...
> [!WARNING]
> Ran with **10 warning(s)** and no fatal errors.<br>Continuity error(s): -0.015 %

**Title:** TEST1 Test DWF (dry weather flow) at nodes  
**Location:** `OWA_ROUTING/routing_dwf.inp`
...
---
<sub>📄 Auto-generated 2026-06-24 • summary of `routing_dwf.inp`</sub>
