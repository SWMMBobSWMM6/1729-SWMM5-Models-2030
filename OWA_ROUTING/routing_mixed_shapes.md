...
> [!CAUTION]
> **Run failed** -- 1 fatal error(s) in `routing_mixed_shapes.rpt`.<br>ERROR 205: invalid keyword SEMI_ELLIPTICAL at line 77 of [XSECT] section:

**Title:** TEST1 Test mixed cross-section shapes in series  
**Location:** `OWA_ROUTING/routing_mixed_shapes.inp`
...
---
<sub>📄 Auto-generated 2026-06-24 • summary of `routing_mixed_shapes.inp`</sub>
