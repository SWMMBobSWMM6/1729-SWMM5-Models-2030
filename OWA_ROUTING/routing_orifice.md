...
> [!WARNING]
> Ran with **2 warning(s)** and no fatal errors.<br>Continuity error(s): -0.001 %

**Title:** TEST - ROUTING WITH ORIFICE Bottom and side orifice test  
**Location:** `OWA_ROUTING/routing_orifice.inp`
...
| Simulation end | 02/02/2002 08:00:00 |
| Duration | 8 hr |
...
---
<sub>📄 Auto-generated 2026-06-24 • summary of `routing_orifice.inp`</sub>
