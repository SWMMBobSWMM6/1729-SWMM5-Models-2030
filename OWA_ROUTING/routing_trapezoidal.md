...
> [!WARNING]
> Ran with **10 warning(s)** and no fatal errors.<br>Continuity error(s): 0.000 %

**Title:** TEST1 Test TRAPEZOIDAL cross-sections  
**Location:** `OWA_ROUTING/routing_trapezoidal.inp`
...
---
<sub>📄 Auto-generated 2026-06-24 • summary of `routing_trapezoidal.inp`</sub>
