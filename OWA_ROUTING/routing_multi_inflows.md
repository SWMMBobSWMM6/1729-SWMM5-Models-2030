...
> [!WARNING]
> Ran with **10 warning(s)** and no fatal errors.<br>Continuity error(s): 0.027 %

**Title:** TEST1 Test multiple inflows at different nodes  
**Location:** `OWA_ROUTING/routing_multi_inflows.inp`
...
---
<sub>📄 Auto-generated 2026-06-24 • summary of `routing_multi_inflows.inp`</sub>
