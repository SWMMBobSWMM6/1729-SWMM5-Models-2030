...
> [!WARNING]
> Ran with **10 warning(s)** and no fatal errors.<br>Continuity error(s): -0.004 %

**Title:** TEST1 Test INERTIAL_DAMPING = PARTIAL  
**Location:** `OWA_ROUTING/routing_inertial_partial.inp`
...
---
<sub>📄 Auto-generated 2026-06-24 • summary of `routing_inertial_partial.inp`</sub>
