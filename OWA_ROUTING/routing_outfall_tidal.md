...
> [!WARNING]
> Ran with **10 warning(s)** and no fatal errors.<br>Continuity error(s): -0.051 %

**Title:** TEST1 Test OUTFALL TIDAL boundary  
**Location:** `OWA_ROUTING/routing_outfall_tidal.inp`
...
---
<sub>📄 Auto-generated 2026-06-24 • summary of `routing_outfall_tidal.inp`</sub>
