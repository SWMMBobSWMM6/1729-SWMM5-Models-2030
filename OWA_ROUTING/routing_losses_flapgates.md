...
> [!WARNING]
> Ran with **10 warning(s)** and no fatal errors.<br>Continuity error(s): -0.012 %

**Title:** TEST1 Test LOSSES entry/exit/average coefficients and flap gates  
**Location:** `OWA_ROUTING/routing_losses_flapgates.inp`
...
---
<sub>📄 Auto-generated 2026-06-24 • summary of `routing_losses_flapgates.inp`</sub>
