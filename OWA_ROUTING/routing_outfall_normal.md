...
> [!WARNING]
> Ran with **9 warning(s)** and no fatal errors.<br>Continuity error(s): -0.007 %

**Title:** TEST1 Test OUTFALL NORMAL depth boundary  
**Location:** `OWA_ROUTING/routing_outfall_normal.inp`
...
---
<sub>📄 Auto-generated 2026-06-24 • summary of `routing_outfall_normal.inp`</sub>
