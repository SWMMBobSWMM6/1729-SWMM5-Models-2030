...
> [!WARNING]
> Ran with **10 warning(s)** and no fatal errors.<br>Continuity error(s): -0.013 %

**Title:** TEST1 Test OUTFALL FIXED stage boundary  
**Location:** `OWA_ROUTING/routing_outfall_fixed.inp`
...
---
<sub>📄 Auto-generated 2026-06-24 • summary of `routing_outfall_fixed.inp`</sub>
