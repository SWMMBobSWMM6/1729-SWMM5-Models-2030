...
> [!WARNING]
> Ran with **10 warning(s)** and no fatal errors.<br>Continuity error(s): -2.525 %

**Title:** TEST1 Test SURCHARGE_METHOD = SLOT  
**Location:** `OWA_ROUTING/routing_surcharge_slot.inp`
...
---
<sub>📄 Auto-generated 2026-06-24 • summary of `routing_surcharge_slot.inp`</sub>
