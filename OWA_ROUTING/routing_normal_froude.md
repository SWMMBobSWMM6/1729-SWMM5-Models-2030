...
> [!WARNING]
> Ran with **10 warning(s)** and no fatal errors.<br>Continuity error(s): -0.008 %

**Title:** TEST1 Test NORMAL_FLOW_LIMITED = FROUDE  
**Location:** `OWA_ROUTING/routing_normal_froude.inp`
...
---
<sub>📄 Auto-generated 2026-06-24 • summary of `routing_normal_froude.inp`</sub>
