...
> [!TIP]
> Ran clean -- no errors or warnings reported.<br>Continuity error(s): -0.224, -0.866 %

**Title:** Example 1 of Extran Manual  
**Location:** `WQ/ERR_CYCLIC_TREATMENT.inp`
...
Pollutants: **2** &nbsp;|&nbsp; Land uses: **0** &nbsp;|&nbsp; Treatment nodes: **2**
...
---
<sub>📄 Auto-generated 2026-06-24 • summary of `ERR_CYCLIC_TREATMENT.inp`</sub>
