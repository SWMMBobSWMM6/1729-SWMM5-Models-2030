...
> [!TIP]
> Ran clean -- no errors or warnings reported.<br>Continuity error(s): -0.607 %

**Title:** HEC-22 example 4-10 where flow capture is 1.76 cfs.  
**Location:** `LEW_CHI_SWMM5.2/Tests_CHI/sweeper_combo_inlet_10.inp`
...
---
<sub>📄 Auto-generated 2026-06-24 • summary of `sweeper_combo_inlet_10.inp`</sub>
