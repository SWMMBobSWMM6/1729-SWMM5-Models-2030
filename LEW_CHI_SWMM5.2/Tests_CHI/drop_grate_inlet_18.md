...
> [!TIP]
> Ran clean -- no errors or warnings reported.<br>Continuity error(s): -0.180 %

**Title:** HEC-22 example 4-18 with captured flow of 5.83 cfs.  
**Location:** `LEW_CHI_SWMM5.2/Tests_CHI/drop_grate_inlet_18.inp`
...
---
<sub>📄 Auto-generated 2026-06-24 • summary of `drop_grate_inlet_18.inp`</sub>
